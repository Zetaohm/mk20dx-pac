...
#[doc = "Field `SB` reader - These bits control the lower space periods of the modulator for all modes."]
pub type SbR = crate::FieldReader;
#[doc = "Field `SB` writer - These bits control the lower space periods of the modulator for all modes."]
pub type SbW<'a, REG> = crate::FieldWriter<'a, REG, 8>;
impl R {
    #[doc = "Bits 0:7 - These bits control the lower space periods of the modulator for all modes."]
    #[inline(always)]
    pub fn sb(&self) -> SbR {
        SbR::new(self.bits)
    }
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn sb(&mut self) -> SbW<Cmd4Spec> {
        SbW::new(self, 0)
    }
}
