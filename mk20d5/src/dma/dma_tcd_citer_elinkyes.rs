...
pub type R = crate::R<DmaTcdCiterElinkyesSpec>;
#[doc = "Register `TCD%s_CITER_ELINKYES` writer"]
pub type W = crate::W<DmaTcdCiterElinkyesSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn citer(&mut self) -> CiterW<DmaTcdCiterElinkyesSpec> {
        CiterW::new(self, 0)
    }
    #[doc = "Bits 9:12 - Link Channel Number"]
    #[inline(always)]
    #[must_use]
    pub fn linkch(&mut self) -> LinkchW<DmaTcdCiterElinkyesSpec> {
        LinkchW::new(self, 9)
    }
    #[doc = "Bit 15 - Enable channel-to-channel linking on minor-loop complete"]
    #[inline(always)]
    #[must_use]
    pub fn elink(&mut self) -> ElinkW<DmaTcdCiterElinkyesSpec> {
        ElinkW::new(self, 15)
    }
}
...
pub struct DmaTcdCiterElinkyesSpec;
impl crate::RegisterSpec for DmaTcdCiterElinkyesSpec {
    type Ux = u16;
}
#[doc = "`read()` method returns [`dma_tcd_citer_elinkyes::R`](R) reader structure"]
impl crate::Readable for DmaTcdCiterElinkyesSpec {}
#[doc = "`write(|w| ..)` method takes [`dma_tcd_citer_elinkyes::W`](W) writer structure"]
impl crate::Writable for DmaTcdCiterElinkyesSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u16 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u16 = 0;
}
#[doc = "`reset()` method sets TCD%s_CITER_ELINKYES to value 0"]
impl crate::Resettable for DmaTcdCiterElinkyesSpec {
