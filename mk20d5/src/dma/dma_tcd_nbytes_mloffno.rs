...
pub type R = crate::R<DmaTcdNbytesMloffnoSpec>;
#[doc = "Register `TCD%s_NBYTES_MLOFFNO` writer"]
pub type W = crate::W<DmaTcdNbytesMloffnoSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn nbytes(&mut self) -> NbytesW<DmaTcdNbytesMloffnoSpec> {
        NbytesW::new(self, 0)
    }
    #[doc = "Bit 30 - Destination Minor Loop Offset enable"]
    #[inline(always)]
    #[must_use]
    pub fn dmloe(&mut self) -> DmloeW<DmaTcdNbytesMloffnoSpec> {
        DmloeW::new(self, 30)
    }
    #[doc = "Bit 31 - Source Minor Loop Offset Enable"]
    #[inline(always)]
    #[must_use]
    pub fn smloe(&mut self) -> SmloeW<DmaTcdNbytesMloffnoSpec> {
        SmloeW::new(self, 31)
    }
}
#[doc = "TCD Signed Minor Loop Offset (Minor Loop Enabled and Offset Disabled)\n\nYou can [`read`](crate::Reg::read) this register and get [`dma_tcd_nbytes_mloffno::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`dma_tcd_nbytes_mloffno::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DmaTcdNbytesMloffnoSpec;
impl crate::RegisterSpec for DmaTcdNbytesMloffnoSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`dma_tcd_nbytes_mloffno::R`](R) reader structure"]
impl crate::Readable for DmaTcdNbytesMloffnoSpec {}
#[doc = "`write(|w| ..)` method takes [`dma_tcd_nbytes_mloffno::W`](W) writer structure"]
impl crate::Writable for DmaTcdNbytesMloffnoSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets TCD%s_NBYTES_MLOFFNO to value 0"]
impl crate::Resettable for DmaTcdNbytesMloffnoSpec {
