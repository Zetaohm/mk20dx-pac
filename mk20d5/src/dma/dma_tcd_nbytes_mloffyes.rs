...
pub type R = crate::R<DmaTcdNbytesMloffyesSpec>;
#[doc = "Register `TCD%s_NBYTES_MLOFFYES` writer"]
pub type W = crate::W<DmaTcdNbytesMloffyesSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn nbytes(&mut self) -> NbytesW<DmaTcdNbytesMloffyesSpec> {
        NbytesW::new(self, 0)
    }
    #[doc = "Bits 10:29 - If SMLOE or DMLOE is set, this field represents a sign-extended offset applied to the source or destination address to form the next-state value after the minor loop completes."]
    #[inline(always)]
    #[must_use]
    pub fn mloff(&mut self) -> MloffW<DmaTcdNbytesMloffyesSpec> {
        MloffW::new(self, 10)
    }
    #[doc = "Bit 30 - Destination Minor Loop Offset enable"]
    #[inline(always)]
    #[must_use]
    pub fn dmloe(&mut self) -> DmloeW<DmaTcdNbytesMloffyesSpec> {
        DmloeW::new(self, 30)
    }
    #[doc = "Bit 31 - Source Minor Loop Offset Enable"]
    #[inline(always)]
    #[must_use]
    pub fn smloe(&mut self) -> SmloeW<DmaTcdNbytesMloffyesSpec> {
        SmloeW::new(self, 31)
    }
}
#[doc = "TCD Signed Minor Loop Offset (Minor Loop and Offset Enabled)\n\nYou can [`read`](crate::Reg::read) this register and get [`dma_tcd_nbytes_mloffyes::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`dma_tcd_nbytes_mloffyes::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DmaTcdNbytesMloffyesSpec;
impl crate::RegisterSpec for DmaTcdNbytesMloffyesSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`dma_tcd_nbytes_mloffyes::R`](R) reader structure"]
impl crate::Readable for DmaTcdNbytesMloffyesSpec {}
#[doc = "`write(|w| ..)` method takes [`dma_tcd_nbytes_mloffyes::W`](W) writer structure"]
impl crate::Writable for DmaTcdNbytesMloffyesSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets TCD%s_NBYTES_MLOFFYES to value 0"]
impl crate::Resettable for DmaTcdNbytesMloffyesSpec {
