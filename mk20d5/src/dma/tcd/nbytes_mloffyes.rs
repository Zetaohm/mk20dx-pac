...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn nbytes(&mut self) -> NbytesW<NbytesMloffyesSpec> {
        NbytesW::new(self, 0)
    }
    #[doc = "Bits 10:29 - If SMLOE or DMLOE is set, this field represents a sign-extended offset applied to the source or destination address to form the next-state value after the minor loop completes."]
    #[inline(always)]
    #[must_use]
    pub fn mloff(&mut self) -> MloffW<NbytesMloffyesSpec> {
        MloffW::new(self, 10)
    }
    #[doc = "Bit 30 - Destination Minor Loop Offset enable"]
    #[inline(always)]
    #[must_use]
    pub fn dmloe(&mut self) -> DmloeW<NbytesMloffyesSpec> {
        DmloeW::new(self, 30)
    }
    #[doc = "Bit 31 - Source Minor Loop Offset Enable"]
    #[inline(always)]
    #[must_use]
    pub fn smloe(&mut self) -> SmloeW<NbytesMloffyesSpec> {
        SmloeW::new(self, 31)
    }
}
