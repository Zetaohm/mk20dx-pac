...
pub type R = crate::R<Tagvdw1sSpec>;
#[doc = "Register `TAGVDW1S%s` writer"]
pub type W = crate::W<Tagvdw1sSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn valid(&mut self) -> ValidW<Tagvdw1sSpec> {
        ValidW::new(self, 0)
    }
    #[doc = "Bits 6:18 - 13-bit tag for cache entry"]
    #[inline(always)]
    #[must_use]
    pub fn tag(&mut self) -> TagW<Tagvdw1sSpec> {
        TagW::new(self, 6)
    }
}
#[doc = "Cache Tag Storage\n\nYou can [`read`](crate::Reg::read) this register and get [`tagvdw1s::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`tagvdw1s::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Tagvdw1sSpec;
impl crate::RegisterSpec for Tagvdw1sSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`tagvdw1s::R`](R) reader structure"]
impl crate::Readable for Tagvdw1sSpec {}
#[doc = "`write(|w| ..)` method takes [`tagvdw1s::W`](W) writer structure"]
impl crate::Writable for Tagvdw1sSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets TAGVDW1S%s to value 0"]
impl crate::Resettable for Tagvdw1sSpec {
