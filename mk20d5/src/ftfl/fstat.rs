    ...
    REG: crate::Writable + crate::RegisterSpec,
{
    ...
    pub fn _0(self) -> &'a mut crate::W<REG> {
        self.variant(Fpviol::_0)
    }
    #[doc = "Protection violation detected"]
    #[inline(always)]
    pub fn _1(self) -> &'a mut crate::W<REG> {
        self.variant(Fpviol::_1)
    }
}
    ...
    REG: crate::Writable + crate::RegisterSpec,
{
    ...
    #[inline(always)]
    pub fn _0(self) -> &'a mut crate::W<REG> {
        self.variant(Accerr::_0)
    }
    #[doc = "Access error detected"]
    #[inline(always)]
    pub fn _1(self) -> &'a mut crate::W<REG> {
        self.variant(Accerr::_1)
    }
}
#[doc = "FTFL Read Collision Error Flag\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum Rdcolerr {
...
#[doc = "Field `RDCOLERR` reader - FTFL Read Collision Error Flag"]
...
#[doc = "Field `RDCOLERR` writer - FTFL Read Collision Error Flag"]
    ...
    REG: crate::Writable + crate::RegisterSpec,
{
    ...
    #[inline(always)]
    pub fn _0(self) -> &'a mut crate::W<REG> {
        self.variant(Rdcolerr::_0)
    }
    #[doc = "Collision error detected"]
    #[inline(always)]
    pub fn _1(self) -> &'a mut crate::W<REG> {
        self.variant(Rdcolerr::_1)
    }
}
#[doc = "Command Complete Interrupt Flag\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum Ccif {
    #[doc = "0: FTFL command or EEPROM file system operation in progress"]
    _0 = 0,
    #[doc = "1: FTFL command or EEPROM file system operation has completed"]
    _1 = 1,
}
...
impl CcifR {
    ...
    #[doc = "FTFL command or EEPROM file system operation in progress"]
    #[inline(always)]
    pub fn is_0(&self) -> bool {
        *self == Ccif::_0
    }
    #[doc = "FTFL command or EEPROM file system operation has completed"]
    #[inline(always)]
    pub fn is_1(&self) -> bool {
        *self == Ccif::_1
    }
    ...
    REG: crate::Writable + crate::RegisterSpec,
{
    ...
    #[inline(always)]
    pub fn _0(self) -> &'a mut crate::W<REG> {
        self.variant(Ccif::_0)
    }
    #[doc = "FTFL command or EEPROM file system operation has completed"]
    #[inline(always)]
    pub fn _1(self) -> &'a mut crate::W<REG> {
        self.variant(Ccif::_1)
    }
}
impl R {
    ...
    #[doc = "Bit 6 - FTFL Read Collision Error Flag"]
    #[inline(always)]
