...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn cntmin(&mut self) -> CntminW<SyncSpec> {
        CntminW::new(self, 0)
    }
    #[doc = "Bit 1 - Maximum loading point enable"]
    #[inline(always)]
    #[must_use]
    pub fn cntmax(&mut self) -> CntmaxW<SyncSpec> {
        CntmaxW::new(self, 1)
    }
    #[doc = "Bit 2 - FTM Counter Reinitialization by Synchronization (FTM Counter Synchronization)"]
    #[inline(always)]
    #[must_use]
    pub fn reinit(&mut self) -> ReinitW<SyncSpec> {
        ReinitW::new(self, 2)
    }
    #[doc = "Bit 3 - Output Mask Synchronization"]
    #[inline(always)]
    #[must_use]
    pub fn synchom(&mut self) -> SynchomW<SyncSpec> {
        SynchomW::new(self, 3)
    }
    #[doc = "Bit 4 - PWM Synchronization Hardware Trigger 0"]
    #[inline(always)]
    #[must_use]
    pub fn trig0(&mut self) -> Trig0W<SyncSpec> {
        Trig0W::new(self, 4)
    }
    #[doc = "Bit 5 - PWM Synchronization Hardware Trigger 1"]
    #[inline(always)]
    #[must_use]
    pub fn trig1(&mut self) -> Trig1W<SyncSpec> {
        Trig1W::new(self, 5)
    }
    #[doc = "Bit 6 - PWM Synchronization Hardware Trigger 2"]
    #[inline(always)]
    #[must_use]
    pub fn trig2(&mut self) -> Trig2W<SyncSpec> {
        Trig2W::new(self, 6)
    }
    #[doc = "Bit 7 - PWM Synchronization Software Trigger"]
    #[inline(always)]
    #[must_use]
    pub fn swsync(&mut self) -> SwsyncW<SyncSpec> {
        SwsyncW::new(self, 7)
    }
}
