...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn tsrw(&mut self) -> TsrwW<WarSpec> {
        TsrwW::new(self, 0)
    }
    #[doc = "Bit 1 - Time Prescaler Register Write"]
    #[inline(always)]
    #[must_use]
    pub fn tprw(&mut self) -> TprwW<WarSpec> {
        TprwW::new(self, 1)
    }
    #[doc = "Bit 2 - Time Alarm Register Write"]
    #[inline(always)]
    #[must_use]
    pub fn tarw(&mut self) -> TarwW<WarSpec> {
        TarwW::new(self, 2)
    }
    #[doc = "Bit 3 - Time Compensation Register Write"]
    #[inline(always)]
    #[must_use]
    pub fn tcrw(&mut self) -> TcrwW<WarSpec> {
        TcrwW::new(self, 3)
    }
    #[doc = "Bit 4 - Control Register Write"]
    #[inline(always)]
    #[must_use]
    pub fn crw(&mut self) -> CrwW<WarSpec> {
        CrwW::new(self, 4)
    }
    #[doc = "Bit 5 - Status Register Write"]
    #[inline(always)]
    #[must_use]
    pub fn srw(&mut self) -> SrwW<WarSpec> {
        SrwW::new(self, 5)
    }
    #[doc = "Bit 6 - Lock Register Write"]
    #[inline(always)]
    #[must_use]
    pub fn lrw(&mut self) -> LrwW<WarSpec> {
        LrwW::new(self, 6)
    }
    #[doc = "Bit 7 - Interrupt Enable Register Write"]
    #[inline(always)]
    #[must_use]
    pub fn ierw(&mut self) -> IerwW<WarSpec> {
        IerwW::new(self, 7)
    }
}
