...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn br(&mut self) -> BrW<Spi0CtarSpec> {
        BrW::new(self, 0)
    }
    #[doc = "Bits 4:7 - Delay After Transfer Scaler"]
    #[inline(always)]
    #[must_use]
    pub fn dt(&mut self) -> DtW<Spi0CtarSpec> {
        DtW::new(self, 4)
    }
    #[doc = "Bits 8:11 - After SCK Delay Scaler"]
    #[inline(always)]
    #[must_use]
    pub fn asc(&mut self) -> AscW<Spi0CtarSpec> {
        AscW::new(self, 8)
    }
    #[doc = "Bits 12:15 - PCS to SCK Delay Scaler"]
    #[inline(always)]
    #[must_use]
    pub fn cssck(&mut self) -> CssckW<Spi0CtarSpec> {
        CssckW::new(self, 12)
    }
    #[doc = "Bits 16:17 - Baud Rate Prescaler"]
    #[inline(always)]
    #[must_use]
    pub fn pbr(&mut self) -> PbrW<Spi0CtarSpec> {
        PbrW::new(self, 16)
    }
    #[doc = "Bits 18:19 - Delay after Transfer Prescaler"]
    #[inline(always)]
    #[must_use]
    pub fn pdt(&mut self) -> PdtW<Spi0CtarSpec> {
        PdtW::new(self, 18)
    }
    #[doc = "Bits 20:21 - After SCK Delay Prescaler"]
    #[inline(always)]
    #[must_use]
    pub fn pasc(&mut self) -> PascW<Spi0CtarSpec> {
        PascW::new(self, 20)
    }
    #[doc = "Bits 22:23 - PCS to SCK Delay Prescaler"]
    #[inline(always)]
    #[must_use]
    pub fn pcssck(&mut self) -> PcssckW<Spi0CtarSpec> {
        PcssckW::new(self, 22)
    }
    #[doc = "Bit 24 - LBS First"]
    #[inline(always)]
    #[must_use]
    pub fn lsbfe(&mut self) -> LsbfeW<Spi0CtarSpec> {
        LsbfeW::new(self, 24)
    }
    #[doc = "Bit 25 - Clock Phase"]
    #[inline(always)]
    #[must_use]
    pub fn cpha(&mut self) -> CphaW<Spi0CtarSpec> {
        CphaW::new(self, 25)
    }
    #[doc = "Bit 26 - Clock Polarity"]
    #[inline(always)]
    #[must_use]
    pub fn cpol(&mut self) -> CpolW<Spi0CtarSpec> {
        CpolW::new(self, 26)
    }
    #[doc = "Bits 27:30 - Frame Size"]
    #[inline(always)]
    #[must_use]
    pub fn fmsz(&mut self) -> FmszW<Spi0CtarSpec> {
        FmszW::new(self, 27)
    }
    #[doc = "Bit 31 - Double Baud Rate"]
    #[inline(always)]
    #[must_use]
    pub fn dbr(&mut self) -> DbrW<Spi0CtarSpec> {
        DbrW::new(self, 31)
    }
}
