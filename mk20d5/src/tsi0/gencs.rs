...
#[doc = "TSI STOP Enable while in Low Power Modes (STOP, VLPS, LLS and VLLS{3,2,1})\n\nValue on reset: 0"]
...
#[doc = "Field `STPE` reader - TSI STOP Enable while in Low Power Modes (STOP, VLPS, LLS and VLLS{3,2,1})"]
...
#[doc = "Field `STPE` writer - TSI STOP Enable while in Low Power Modes (STOP, VLPS, LLS and VLLS{3,2,1})"]
...
impl R {
    #[doc = "Bit 0 - TSI STOP Enable while in Low Power Modes (STOP, VLPS, LLS and VLLS{3,2,1})"]
    #[inline(always)]
