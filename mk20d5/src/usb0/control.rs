...
#[doc = "Provides control of the DP PULLUP in the USB OTG module, if USB is configured in non-OTG device mode\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum Dppullupnonotg {
    #[doc = "0: DP Pull up in non-OTG device mode is not enabled."]
    _0 = 0,
    #[doc = "1: DP Pull up in non-OTG device mode is enabled."]
    _1 = 1,
}
...
#[doc = "Field `DPPULLUPNONOTG` reader - Provides control of the DP PULLUP in the USB OTG module, if USB is configured in non-OTG device mode"]
...
impl DppullupnonotgR {
    ...
    pub const fn variant(&self) -> Dppullupnonotg {
        match self.bits {
            false => Dppullupnonotg::_0,
            true => Dppullupnonotg::_1,
        }
    }
    #[doc = "DP Pull up in non-OTG device mode is not enabled."]
    #[inline(always)]
    pub fn is_0(&self) -> bool {
        *self == Dppullupnonotg::_0
    }
    #[doc = "DP Pull up in non-OTG device mode is enabled."]
    #[inline(always)]
    pub fn is_1(&self) -> bool {
        *self == Dppullupnonotg::_1
    }
}
#[doc = "Field `DPPULLUPNONOTG` writer - Provides control of the DP PULLUP in the USB OTG module, if USB is configured in non-OTG device mode"]
    ...
    REG: crate::Writable + crate::RegisterSpec,
{
    ...
    pub fn _0(self) -> &'a mut crate::W<REG> {
        self.variant(Dppullupnonotg::_0)
    }
    #[doc = "DP Pull up in non-OTG device mode is enabled."]
    #[inline(always)]
    pub fn _1(self) -> &'a mut crate::W<REG> {
        self.variant(Dppullupnonotg::_1)
    }
}
impl R {
