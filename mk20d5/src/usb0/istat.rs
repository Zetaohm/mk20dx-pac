...
#[doc = "Field `ERROR` reader - This bit is set when any of the error conditions within the ERRSTAT register occur"]
pub type ErrorR = crate::BitReader;
#[doc = "Field `ERROR` writer - This bit is set when any of the error conditions within the ERRSTAT register occur"]
...
#[doc = "Field `SLEEP` reader - This bit is set when the USB Module detects a constant idle on the USB bus for 3 milliseconds"]
pub type SleepR = crate::BitReader;
#[doc = "Field `SLEEP` writer - This bit is set when the USB Module detects a constant idle on the USB bus for 3 milliseconds"]
pub type SleepW<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `RESUME` reader - This bit is set depending upon the DP/DM signals, and can be used to signal remote wake-up signaling on the USB bus"]
pub type ResumeR = crate::BitReader;
#[doc = "Field `RESUME` writer - This bit is set depending upon the DP/DM signals, and can be used to signal remote wake-up signaling on the USB bus"]
