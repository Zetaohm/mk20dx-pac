...
#[doc = "Field `CNT` reader - This 8-bit field represents the SOF count threshold in byte times."]
pub type CntR = crate::FieldReader;
#[doc = "Field `CNT` writer - This 8-bit field represents the SOF count threshold in byte times."]
