#[doc = "Register `PACRK` reader"]
pub type R = crate::R<PacrkSpec>;
#[doc = "Register `PACRK` writer"]
pub type W = crate::W<PacrkSpec>;
#[doc = "Trusted protect\n\nValue on reset: 0"]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn tp7(&mut self) -> Tp7W<PacrkSpec> {
        Tp7W::new(self, 0)
    }
    #[doc = "Bit 1 - Write protect"]
    #[inline(always)]
    #[must_use]
    pub fn wp7(&mut self) -> Wp7W<PacrkSpec> {
        Wp7W::new(self, 1)
    }
    #[doc = "Bit 2 - Supervisor protect"]
    #[inline(always)]
    #[must_use]
    pub fn sp7(&mut self) -> Sp7W<PacrkSpec> {
        Sp7W::new(self, 2)
    }
    #[doc = "Bit 4 - Trusted protect"]
    #[inline(always)]
    #[must_use]
    pub fn tp6(&mut self) -> Tp6W<PacrkSpec> {
        Tp6W::new(self, 4)
    }
    #[doc = "Bit 5 - Write protect"]
    #[inline(always)]
    #[must_use]
    pub fn wp6(&mut self) -> Wp6W<PacrkSpec> {
        Wp6W::new(self, 5)
    }
    #[doc = "Bit 6 - Supervisor protect"]
    #[inline(always)]
    #[must_use]
    pub fn sp6(&mut self) -> Sp6W<PacrkSpec> {
        Sp6W::new(self, 6)
    }
    #[doc = "Bit 8 - Trusted protect"]
    #[inline(always)]
    #[must_use]
    pub fn tp5(&mut self) -> Tp5W<PacrkSpec> {
        Tp5W::new(self, 8)
    }
    #[doc = "Bit 9 - Write protect"]
    #[inline(always)]
    #[must_use]
    pub fn wp5(&mut self) -> Wp5W<PacrkSpec> {
        Wp5W::new(self, 9)
    }
    #[doc = "Bit 10 - Supervisor protect"]
    #[inline(always)]
    #[must_use]
    pub fn sp5(&mut self) -> Sp5W<PacrkSpec> {
        Sp5W::new(self, 10)
    }
    #[doc = "Bit 12 - Trusted protect"]
    #[inline(always)]
    #[must_use]
    pub fn tp4(&mut self) -> Tp4W<PacrkSpec> {
        Tp4W::new(self, 12)
    }
    #[doc = "Bit 13 - Write protect"]
    #[inline(always)]
    #[must_use]
    pub fn wp4(&mut self) -> Wp4W<PacrkSpec> {
        Wp4W::new(self, 13)
    }
    #[doc = "Bit 14 - Supervisor protect"]
    #[inline(always)]
    #[must_use]
    pub fn sp4(&mut self) -> Sp4W<PacrkSpec> {
        Sp4W::new(self, 14)
    }
    #[doc = "Bit 16 - Trusted protect"]
    #[inline(always)]
    #[must_use]
    pub fn tp3(&mut self) -> Tp3W<PacrkSpec> {
        Tp3W::new(self, 16)
    }
    #[doc = "Bit 17 - Write protect"]
    #[inline(always)]
    #[must_use]
    pub fn wp3(&mut self) -> Wp3W<PacrkSpec> {
        Wp3W::new(self, 17)
    }
    #[doc = "Bit 18 - Supervisor protect"]
    #[inline(always)]
    #[must_use]
    pub fn sp3(&mut self) -> Sp3W<PacrkSpec> {
        Sp3W::new(self, 18)
    }
    #[doc = "Bit 20 - Trusted protect"]
    #[inline(always)]
    #[must_use]
    pub fn tp2(&mut self) -> Tp2W<PacrkSpec> {
        Tp2W::new(self, 20)
    }
    #[doc = "Bit 21 - Write protect"]
    #[inline(always)]
    #[must_use]
    pub fn wp2(&mut self) -> Wp2W<PacrkSpec> {
        Wp2W::new(self, 21)
    }
    #[doc = "Bit 22 - Supervisor protect"]
    #[inline(always)]
    #[must_use]
    pub fn sp2(&mut self) -> Sp2W<PacrkSpec> {
        Sp2W::new(self, 22)
    }
    #[doc = "Bit 24 - Trusted protect"]
    #[inline(always)]
    #[must_use]
    pub fn tp1(&mut self) -> Tp1W<PacrkSpec> {
        Tp1W::new(self, 24)
    }
    #[doc = "Bit 25 - Write protect"]
    #[inline(always)]
    #[must_use]
    pub fn wp1(&mut self) -> Wp1W<PacrkSpec> {
        Wp1W::new(self, 25)
    }
    #[doc = "Bit 26 - Supervisor protect"]
    #[inline(always)]
    #[must_use]
    pub fn sp1(&mut self) -> Sp1W<PacrkSpec> {
        Sp1W::new(self, 26)
    }
    #[doc = "Bit 28 - Trusted protect"]
    #[inline(always)]
    #[must_use]
    pub fn tp0(&mut self) -> Tp0W<PacrkSpec> {
        Tp0W::new(self, 28)
    }
    #[doc = "Bit 29 - Write protect"]
    #[inline(always)]
    #[must_use]
    pub fn wp0(&mut self) -> Wp0W<PacrkSpec> {
        Wp0W::new(self, 29)
    }
    #[doc = "Bit 30 - Supervisor protect"]
    #[inline(always)]
    #[must_use]
    pub fn sp0(&mut self) -> Sp0W<PacrkSpec> {
        Sp0W::new(self, 30)
    }
}
#[doc = "Peripheral Access Control Register\n\nYou can [`read`](crate::Reg::read) this register and get [`pacrk::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`pacrk::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct PacrkSpec;
impl crate::RegisterSpec for PacrkSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`pacrk::R`](R) reader structure"]
impl crate::Readable for PacrkSpec {}
#[doc = "`write(|w| ..)` method takes [`pacrk::W`](W) writer structure"]
impl crate::Writable for PacrkSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets PACRK to value 0"]
impl crate::Resettable for PacrkSpec {
