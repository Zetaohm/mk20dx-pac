#[doc = "Register `PACRO` reader"]
pub type R = crate::R<PacroSpec>;
#[doc = "Register `PACRO` writer"]
pub type W = crate::W<PacroSpec>;
#[doc = "Trusted protect\n\nValue on reset: 0"]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn tp7(&mut self) -> Tp7W<PacroSpec> {
        Tp7W::new(self, 0)
    }
    #[doc = "Bit 1 - Write protect"]
    #[inline(always)]
    #[must_use]
    pub fn wp7(&mut self) -> Wp7W<PacroSpec> {
        Wp7W::new(self, 1)
    }
    #[doc = "Bit 2 - Supervisor protect"]
    #[inline(always)]
    #[must_use]
    pub fn sp7(&mut self) -> Sp7W<PacroSpec> {
        Sp7W::new(self, 2)
    }
    #[doc = "Bit 4 - Trusted protect"]
    #[inline(always)]
    #[must_use]
    pub fn tp6(&mut self) -> Tp6W<PacroSpec> {
        Tp6W::new(self, 4)
    }
    #[doc = "Bit 5 - Write protect"]
    #[inline(always)]
    #[must_use]
    pub fn wp6(&mut self) -> Wp6W<PacroSpec> {
        Wp6W::new(self, 5)
    }
    #[doc = "Bit 6 - Supervisor protect"]
    #[inline(always)]
    #[must_use]
    pub fn sp6(&mut self) -> Sp6W<PacroSpec> {
        Sp6W::new(self, 6)
    }
    #[doc = "Bit 8 - Trusted protect"]
    #[inline(always)]
    #[must_use]
    pub fn tp5(&mut self) -> Tp5W<PacroSpec> {
        Tp5W::new(self, 8)
    }
    #[doc = "Bit 9 - Write protect"]
    #[inline(always)]
    #[must_use]
    pub fn wp5(&mut self) -> Wp5W<PacroSpec> {
        Wp5W::new(self, 9)
    }
    #[doc = "Bit 10 - Supervisor protect"]
    #[inline(always)]
    #[must_use]
    pub fn sp5(&mut self) -> Sp5W<PacroSpec> {
        Sp5W::new(self, 10)
    }
    #[doc = "Bit 12 - Trusted protect"]
    #[inline(always)]
    #[must_use]
    pub fn tp4(&mut self) -> Tp4W<PacroSpec> {
        Tp4W::new(self, 12)
    }
    #[doc = "Bit 13 - Write protect"]
    #[inline(always)]
    #[must_use]
    pub fn wp4(&mut self) -> Wp4W<PacroSpec> {
        Wp4W::new(self, 13)
    }
    #[doc = "Bit 14 - Supervisor protect"]
    #[inline(always)]
    #[must_use]
    pub fn sp4(&mut self) -> Sp4W<PacroSpec> {
        Sp4W::new(self, 14)
    }
    #[doc = "Bit 16 - Trusted protect"]
    #[inline(always)]
    #[must_use]
    pub fn tp3(&mut self) -> Tp3W<PacroSpec> {
        Tp3W::new(self, 16)
    }
    #[doc = "Bit 17 - Write protect"]
    #[inline(always)]
    #[must_use]
    pub fn wp3(&mut self) -> Wp3W<PacroSpec> {
        Wp3W::new(self, 17)
    }
    #[doc = "Bit 18 - Supervisor protect"]
    #[inline(always)]
    #[must_use]
    pub fn sp3(&mut self) -> Sp3W<PacroSpec> {
        Sp3W::new(self, 18)
    }
    #[doc = "Bit 20 - Trusted protect"]
    #[inline(always)]
    #[must_use]
    pub fn tp2(&mut self) -> Tp2W<PacroSpec> {
        Tp2W::new(self, 20)
    }
    #[doc = "Bit 21 - Write protect"]
    #[inline(always)]
    #[must_use]
    pub fn wp2(&mut self) -> Wp2W<PacroSpec> {
        Wp2W::new(self, 21)
    }
    #[doc = "Bit 22 - Supervisor protect"]
    #[inline(always)]
    #[must_use]
    pub fn sp2(&mut self) -> Sp2W<PacroSpec> {
        Sp2W::new(self, 22)
    }
    #[doc = "Bit 24 - Trusted protect"]
    #[inline(always)]
    #[must_use]
    pub fn tp1(&mut self) -> Tp1W<PacroSpec> {
        Tp1W::new(self, 24)
    }
    #[doc = "Bit 25 - Write protect"]
    #[inline(always)]
    #[must_use]
    pub fn wp1(&mut self) -> Wp1W<PacroSpec> {
        Wp1W::new(self, 25)
    }
    #[doc = "Bit 26 - Supervisor protect"]
    #[inline(always)]
    #[must_use]
    pub fn sp1(&mut self) -> Sp1W<PacroSpec> {
        Sp1W::new(self, 26)
    }
    #[doc = "Bit 28 - Trusted protect"]
    #[inline(always)]
    #[must_use]
    pub fn tp0(&mut self) -> Tp0W<PacroSpec> {
        Tp0W::new(self, 28)
    }
    #[doc = "Bit 29 - Write protect"]
    #[inline(always)]
    #[must_use]
    pub fn wp0(&mut self) -> Wp0W<PacroSpec> {
        Wp0W::new(self, 29)
    }
    #[doc = "Bit 30 - Supervisor protect"]
    #[inline(always)]
    #[must_use]
    pub fn sp0(&mut self) -> Sp0W<PacroSpec> {
        Sp0W::new(self, 30)
    }
}
#[doc = "Peripheral Access Control Register\n\nYou can [`read`](crate::Reg::read) this register and get [`pacro::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`pacro::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct PacroSpec;
impl crate::RegisterSpec for PacroSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`pacro::R`](R) reader structure"]
impl crate::Readable for PacroSpec {}
#[doc = "`write(|w| ..)` method takes [`pacro::W`](W) writer structure"]
impl crate::Writable for PacroSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets PACRO to value 0"]
impl crate::Resettable for PacroSpec {
