#[doc = "Register `CS14` reader"]
pub type R = crate::R<Cs14Spec>;
#[doc = "Register `CS14` writer"]
pub type W = crate::W<Cs14Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn time_stamp(&mut self) -> TimeStampW<Cs14Spec> {
        TimeStampW::new(self, 0)
    }
    #[doc = "Bits 16:19 - Length of the data to be stored/transmitted."]
    #[inline(always)]
    #[must_use]
    pub fn dlc(&mut self) -> DlcW<Cs14Spec> {
        DlcW::new(self, 16)
    }
    #[doc = "Bit 20 - Remote Transmission Request. One/zero for remote/data frame."]
    #[inline(always)]
    #[must_use]
    pub fn rtr(&mut self) -> RtrW<Cs14Spec> {
        RtrW::new(self, 20)
    }
    #[doc = "Bit 21 - ID Extended. One/zero for extended/standard format frame."]
    #[inline(always)]
    #[must_use]
    pub fn ide(&mut self) -> IdeW<Cs14Spec> {
        IdeW::new(self, 21)
    }
    #[doc = "Bit 22 - Substitute Remote Request. Contains a fixed recessive bit."]
    #[inline(always)]
    #[must_use]
    pub fn srr(&mut self) -> SrrW<Cs14Spec> {
        SrrW::new(self, 22)
    }
    #[doc = "Bits 24:27 - Reserved"]
    #[inline(always)]
    #[must_use]
    pub fn code(&mut self) -> CodeW<Cs14Spec> {
        CodeW::new(self, 24)
    }
}
#[doc = "Message Buffer 14 CS Register\n\nYou can [`read`](crate::Reg::read) this register and get [`cs14::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`cs14::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Cs14Spec;
impl crate::RegisterSpec for Cs14Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`cs14::R`](R) reader structure"]
impl crate::Readable for Cs14Spec {}
#[doc = "`write(|w| ..)` method takes [`cs14::W`](W) writer structure"]
impl crate::Writable for Cs14Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets CS14 to value 0"]
impl crate::Resettable for Cs14Spec {
