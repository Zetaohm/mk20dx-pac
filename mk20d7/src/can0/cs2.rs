...
pub type R = crate::R<Cs2Spec>;
#[doc = "Register `CS2` writer"]
pub type W = crate::W<Cs2Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn time_stamp(&mut self) -> TimeStampW<Cs2Spec> {
        TimeStampW::new(self, 0)
    }
    #[doc = "Bits 16:19 - Length of the data to be stored/transmitted."]
    #[inline(always)]
    #[must_use]
    pub fn dlc(&mut self) -> DlcW<Cs2Spec> {
        DlcW::new(self, 16)
    }
    #[doc = "Bit 20 - Remote Transmission Request. One/zero for remote/data frame."]
    #[inline(always)]
    #[must_use]
    pub fn rtr(&mut self) -> RtrW<Cs2Spec> {
        RtrW::new(self, 20)
    }
    #[doc = "Bit 21 - ID Extended. One/zero for extended/standard format frame."]
    #[inline(always)]
    #[must_use]
    pub fn ide(&mut self) -> IdeW<Cs2Spec> {
        IdeW::new(self, 21)
    }
    #[doc = "Bit 22 - Substitute Remote Request. Contains a fixed recessive bit."]
    #[inline(always)]
    #[must_use]
    pub fn srr(&mut self) -> SrrW<Cs2Spec> {
        SrrW::new(self, 22)
    }
    #[doc = "Bits 24:27 - Reserved"]
    #[inline(always)]
    #[must_use]
    pub fn code(&mut self) -> CodeW<Cs2Spec> {
        CodeW::new(self, 24)
    }
}
#[doc = "Message Buffer 2 CS Register\n\nYou can [`read`](crate::Reg::read) this register and get [`cs2::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`cs2::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Cs2Spec;
impl crate::RegisterSpec for Cs2Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`cs2::R`](R) reader structure"]
impl crate::Readable for Cs2Spec {}
#[doc = "`write(|w| ..)` method takes [`cs2::W`](W) writer structure"]
impl crate::Writable for Cs2Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets CS2 to value 0"]
impl crate::Resettable for Cs2Spec {
