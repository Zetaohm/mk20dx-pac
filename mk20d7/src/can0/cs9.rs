#[doc = "Register `CS9` reader"]
pub type R = crate::R<Cs9Spec>;
#[doc = "Register `CS9` writer"]
pub type W = crate::W<Cs9Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn time_stamp(&mut self) -> TimeStampW<Cs9Spec> {
        TimeStampW::new(self, 0)
    }
    #[doc = "Bits 16:19 - Length of the data to be stored/transmitted."]
    #[inline(always)]
    #[must_use]
    pub fn dlc(&mut self) -> DlcW<Cs9Spec> {
        DlcW::new(self, 16)
    }
    #[doc = "Bit 20 - Remote Transmission Request. One/zero for remote/data frame."]
    #[inline(always)]
    #[must_use]
    pub fn rtr(&mut self) -> RtrW<Cs9Spec> {
        RtrW::new(self, 20)
    }
    #[doc = "Bit 21 - ID Extended. One/zero for extended/standard format frame."]
    #[inline(always)]
    #[must_use]
    pub fn ide(&mut self) -> IdeW<Cs9Spec> {
        IdeW::new(self, 21)
    }
    #[doc = "Bit 22 - Substitute Remote Request. Contains a fixed recessive bit."]
    #[inline(always)]
    #[must_use]
    pub fn srr(&mut self) -> SrrW<Cs9Spec> {
        SrrW::new(self, 22)
    }
    #[doc = "Bits 24:27 - Reserved"]
    #[inline(always)]
    #[must_use]
    pub fn code(&mut self) -> CodeW<Cs9Spec> {
        CodeW::new(self, 24)
    }
}
#[doc = "Message Buffer 9 CS Register\n\nYou can [`read`](crate::Reg::read) this register and get [`cs9::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`cs9::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Cs9Spec;
impl crate::RegisterSpec for Cs9Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`cs9::R`](R) reader structure"]
impl crate::Readable for Cs9Spec {}
#[doc = "`write(|w| ..)` method takes [`cs9::W`](W) writer structure"]
impl crate::Writable for Cs9Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets CS9 to value 0"]
impl crate::Resettable for Cs9Spec {
