#[doc = "Register `ID15` reader"]
pub type R = crate::R<Id15Spec>;
#[doc = "Register `ID15` writer"]
pub type W = crate::W<Id15Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ext(&mut self) -> ExtW<Id15Spec> {
        ExtW::new(self, 0)
    }
    #[doc = "Bits 18:28 - Contains standard/extended (HIGH word) identifier of message buffer."]
    #[inline(always)]
    #[must_use]
    pub fn std(&mut self) -> StdW<Id15Spec> {
        StdW::new(self, 18)
    }
    #[doc = "Bits 29:31 - Local priority. This 3-bit fieldis only used when LPRIO_EN bit is set in MCR and it only makes sense for Tx buffers. These bits are not transmitted. They are appended to the regular ID to define the transmission priority."]
    #[inline(always)]
    #[must_use]
    pub fn prio(&mut self) -> PrioW<Id15Spec> {
        PrioW::new(self, 29)
    }
}
#[doc = "Message Buffer 15 ID Register\n\nYou can [`read`](crate::Reg::read) this register and get [`id15::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`id15::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Id15Spec;
impl crate::RegisterSpec for Id15Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`id15::R`](R) reader structure"]
impl crate::Readable for Id15Spec {}
#[doc = "`write(|w| ..)` method takes [`id15::W`](W) writer structure"]
impl crate::Writable for Id15Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets ID15 to value 0"]
impl crate::Resettable for Id15Spec {
