#[doc = "Register `ID9` reader"]
pub type R = crate::R<Id9Spec>;
#[doc = "Register `ID9` writer"]
pub type W = crate::W<Id9Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ext(&mut self) -> ExtW<Id9Spec> {
        ExtW::new(self, 0)
    }
    #[doc = "Bits 18:28 - Contains standard/extended (HIGH word) identifier of message buffer."]
    #[inline(always)]
    #[must_use]
    pub fn std(&mut self) -> StdW<Id9Spec> {
        StdW::new(self, 18)
    }
    #[doc = "Bits 29:31 - Local priority. This 3-bit fieldis only used when LPRIO_EN bit is set in MCR and it only makes sense for Tx buffers. These bits are not transmitted. They are appended to the regular ID to define the transmission priority."]
    #[inline(always)]
    #[must_use]
    pub fn prio(&mut self) -> PrioW<Id9Spec> {
        PrioW::new(self, 29)
    }
}
#[doc = "Message Buffer 9 ID Register\n\nYou can [`read`](crate::Reg::read) this register and get [`id9::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`id9::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Id9Spec;
impl crate::RegisterSpec for Id9Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`id9::R`](R) reader structure"]
impl crate::Readable for Id9Spec {}
#[doc = "`write(|w| ..)` method takes [`id9::W`](W) writer structure"]
impl crate::Writable for Id9Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets ID9 to value 0"]
impl crate::Resettable for Id9Spec {
