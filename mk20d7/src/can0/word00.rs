...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn data_byte_3(&mut self) -> DataByte3W<Word00Spec> {
        DataByte3W::new(self, 0)
    }
    #[doc = "Bits 8:15 - Data byte 2 of Rx/Tx frame."]
    #[inline(always)]
    #[must_use]
    pub fn data_byte_2(&mut self) -> DataByte2W<Word00Spec> {
        DataByte2W::new(self, 8)
    }
    #[doc = "Bits 16:23 - Data byte 1 of Rx/Tx frame."]
    #[inline(always)]
    #[must_use]
    pub fn data_byte_1(&mut self) -> DataByte1W<Word00Spec> {
        DataByte1W::new(self, 16)
    }
    #[doc = "Bits 24:31 - Data byte 0 of Rx/Tx frame."]
    #[inline(always)]
    #[must_use]
    pub fn data_byte_0(&mut self) -> DataByte0W<Word00Spec> {
