#[doc = "Register `WORD012` reader"]
pub type R = crate::R<Word012Spec>;
#[doc = "Register `WORD012` writer"]
pub type W = crate::W<Word012Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn data_byte_3(&mut self) -> DataByte3W<Word012Spec> {
        DataByte3W::new(self, 0)
    }
    #[doc = "Bits 8:15 - Data byte 2 of Rx/Tx frame."]
    #[inline(always)]
    #[must_use]
    pub fn data_byte_2(&mut self) -> DataByte2W<Word012Spec> {
        DataByte2W::new(self, 8)
    }
    #[doc = "Bits 16:23 - Data byte 1 of Rx/Tx frame."]
    #[inline(always)]
    #[must_use]
    pub fn data_byte_1(&mut self) -> DataByte1W<Word012Spec> {
        DataByte1W::new(self, 16)
    }
    #[doc = "Bits 24:31 - Data byte 0 of Rx/Tx frame."]
    #[inline(always)]
    #[must_use]
    pub fn data_byte_0(&mut self) -> DataByte0W<Word012Spec> {
        DataByte0W::new(self, 24)
    }
}
#[doc = "Message Buffer 12 WORD0 Register\n\nYou can [`read`](crate::Reg::read) this register and get [`word012::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`word012::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Word012Spec;
impl crate::RegisterSpec for Word012Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`word012::R`](R) reader structure"]
impl crate::Readable for Word012Spec {}
#[doc = "`write(|w| ..)` method takes [`word012::W`](W) writer structure"]
impl crate::Writable for Word012Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets WORD012 to value 0"]
impl crate::Resettable for Word012Spec {
