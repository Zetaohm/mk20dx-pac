#[doc = "Register `WORD19` reader"]
pub type R = crate::R<Word19Spec>;
#[doc = "Register `WORD19` writer"]
pub type W = crate::W<Word19Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn data_byte_7(&mut self) -> DataByte7W<Word19Spec> {
        DataByte7W::new(self, 0)
    }
    #[doc = "Bits 8:15 - Data byte 6 of Rx/Tx frame."]
    #[inline(always)]
    #[must_use]
    pub fn data_byte_6(&mut self) -> DataByte6W<Word19Spec> {
        DataByte6W::new(self, 8)
    }
    #[doc = "Bits 16:23 - Data byte 5 of Rx/Tx frame."]
    #[inline(always)]
    #[must_use]
    pub fn data_byte_5(&mut self) -> DataByte5W<Word19Spec> {
        DataByte5W::new(self, 16)
    }
    #[doc = "Bits 24:31 - Data byte 4 of Rx/Tx frame."]
    #[inline(always)]
    #[must_use]
    pub fn data_byte_4(&mut self) -> DataByte4W<Word19Spec> {
        DataByte4W::new(self, 24)
    }
}
#[doc = "Message Buffer 9 WORD1 Register\n\nYou can [`read`](crate::Reg::read) this register and get [`word19::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`word19::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Word19Spec;
impl crate::RegisterSpec for Word19Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`word19::R`](R) reader structure"]
impl crate::Readable for Word19Spec {}
#[doc = "`write(|w| ..)` method takes [`word19::W`](W) writer structure"]
impl crate::Writable for Word19Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets WORD19 to value 0"]
impl crate::Resettable for Word19Spec {
