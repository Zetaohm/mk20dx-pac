...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn mcgen(&mut self) -> McgenW<MscSpec> {
        McgenW::new(self, 0)
    }
    #[doc = "Bit 1 - End of Cycle Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn eocie(&mut self) -> EocieW<MscSpec> {
        EocieW::new(self, 1)
    }
    #[doc = "Bit 2 - FSK Mode Select"]
    #[inline(always)]
    #[must_use]
    pub fn fsk(&mut self) -> FskW<MscSpec> {
        FskW::new(self, 2)
    }
    #[doc = "Bit 3 - Baseband Enable"]
    #[inline(always)]
    #[must_use]
    pub fn base(&mut self) -> BaseW<MscSpec> {
        BaseW::new(self, 3)
    }
    #[doc = "Bit 4 - Extended Space Enable"]
    #[inline(always)]
    #[must_use]
    pub fn exspc(&mut self) -> ExspcW<MscSpec> {
        ExspcW::new(self, 4)
    }
    #[doc = "Bits 5:6 - CMT Clock Divide Prescaler"]
    #[inline(always)]
    #[must_use]
    pub fn cmtdiv(&mut self) -> CmtdivW<MscSpec> {
        CmtdivW::new(self, 5)
    }
}
