...
pub type R = crate::R<CtrlhuSpec>;
#[doc = "Register `CTRLHU` writer"]
pub type W = crate::W<CtrlhuSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn tcrc(&mut self) -> TcrcW<CtrlhuSpec> {
        TcrcW::new(self, 0)
    }
    #[doc = "Bit 1 - no description available"]
    #[inline(always)]
    #[must_use]
    pub fn was(&mut self) -> WasW<CtrlhuSpec> {
        WasW::new(self, 1)
    }
    #[doc = "Bit 2 - no description available"]
    #[inline(always)]
    #[must_use]
    pub fn fxor(&mut self) -> FxorW<CtrlhuSpec> {
        FxorW::new(self, 2)
    }
    #[doc = "Bits 4:5 - no description available"]
    #[inline(always)]
    #[must_use]
    pub fn totr(&mut self) -> TotrW<CtrlhuSpec> {
        TotrW::new(self, 4)
    }
    #[doc = "Bits 6:7 - no description available"]
    #[inline(always)]
    #[must_use]
    pub fn tot(&mut self) -> TotW<CtrlhuSpec> {
        TotW::new(self, 6)
    }
}
#[doc = "CRC_CTRLHU register.\n\nYou can [`read`](crate::Reg::read) this register and get [`ctrlhu::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`ctrlhu::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct CtrlhuSpec;
impl crate::RegisterSpec for CtrlhuSpec {
    type Ux = u8;
}
#[doc = "`read()` method returns [`ctrlhu::R`](R) reader structure"]
impl crate::Readable for CtrlhuSpec {}
#[doc = "`write(|w| ..)` method takes [`ctrlhu::W`](W) writer structure"]
impl crate::Writable for CtrlhuSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u8 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u8 = 0;
}
#[doc = "`reset()` method sets CTRLHU to value 0"]
impl crate::Resettable for CtrlhuSpec {
