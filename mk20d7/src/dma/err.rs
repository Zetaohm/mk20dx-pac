...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn err0(&mut self) -> Err0W<ErrSpec> {
        Err0W::new(self, 0)
    }
    #[doc = "Bit 1 - Error In Channel 1"]
    #[inline(always)]
    #[must_use]
    pub fn err1(&mut self) -> Err1W<ErrSpec> {
        Err1W::new(self, 1)
    }
    #[doc = "Bit 2 - Error In Channel 2"]
    #[inline(always)]
    #[must_use]
    pub fn err2(&mut self) -> Err2W<ErrSpec> {
        Err2W::new(self, 2)
    }
    #[doc = "Bit 3 - Error In Channel 3"]
    #[inline(always)]
    #[must_use]
    pub fn err3(&mut self) -> Err3W<ErrSpec> {
        Err3W::new(self, 3)
    }
    #[doc = "Bit 4 - Error In Channel 4"]
    #[inline(always)]
    #[must_use]
    pub fn err4(&mut self) -> Err4W<ErrSpec> {
        Err4W::new(self, 4)
    }
    #[doc = "Bit 5 - Error In Channel 5"]
    #[inline(always)]
    #[must_use]
    pub fn err5(&mut self) -> Err5W<ErrSpec> {
        Err5W::new(self, 5)
    }
    #[doc = "Bit 6 - Error In Channel 6"]
    #[inline(always)]
    #[must_use]
    pub fn err6(&mut self) -> Err6W<ErrSpec> {
        Err6W::new(self, 6)
    }
    #[doc = "Bit 7 - Error In Channel 7"]
    #[inline(always)]
    #[must_use]
    pub fn err7(&mut self) -> Err7W<ErrSpec> {
        Err7W::new(self, 7)
    }
    #[doc = "Bit 8 - Error In Channel 8"]
    #[inline(always)]
    #[must_use]
    pub fn err8(&mut self) -> Err8W<ErrSpec> {
        Err8W::new(self, 8)
    }
    #[doc = "Bit 9 - Error In Channel 9"]
    #[inline(always)]
    #[must_use]
    pub fn err9(&mut self) -> Err9W<ErrSpec> {
        Err9W::new(self, 9)
    }
    #[doc = "Bit 10 - Error In Channel 10"]
    #[inline(always)]
    #[must_use]
    pub fn err10(&mut self) -> Err10W<ErrSpec> {
        Err10W::new(self, 10)
    }
    #[doc = "Bit 11 - Error In Channel 11"]
    #[inline(always)]
    #[must_use]
    pub fn err11(&mut self) -> Err11W<ErrSpec> {
        Err11W::new(self, 11)
    }
    #[doc = "Bit 12 - Error In Channel 12"]
    #[inline(always)]
    #[must_use]
    pub fn err12(&mut self) -> Err12W<ErrSpec> {
        Err12W::new(self, 12)
    }
    #[doc = "Bit 13 - Error In Channel 13"]
    #[inline(always)]
    #[must_use]
    pub fn err13(&mut self) -> Err13W<ErrSpec> {
        Err13W::new(self, 13)
    }
    #[doc = "Bit 14 - Error In Channel 14"]
    #[inline(always)]
    #[must_use]
    pub fn err14(&mut self) -> Err14W<ErrSpec> {
        Err14W::new(self, 14)
    }
    #[doc = "Bit 15 - Error In Channel 15"]
    #[inline(always)]
    #[must_use]
    pub fn err15(&mut self) -> Err15W<ErrSpec> {
        Err15W::new(self, 15)
    }
}
