...
#[doc = "Field `EEERDY` reader - no description available"]
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum Swap {
    #[doc = "0: Physical program flash 0 is located at relative address 0x0000"]
    _0 = 0,
    #[doc = "1: If the PFLSH flag is set, physical program flash 1 is located at relative address 0x0000. If the PFLSH flag is not set, physical program flash 0 is located at relative address 0x0000"]
    _1 = 1,
}
...
impl SwapR {
    ...
    #[doc = "Physical program flash 0 is located at relative address 0x0000"]
    #[inline(always)]
    pub fn is_0(&self) -> bool {
        *self == Swap::_0
    }
    #[doc = "If the PFLSH flag is set, physical program flash 1 is located at relative address 0x0000. If the PFLSH flag is not set, physical program flash 0 is located at relative address 0x0000"]
    #[inline(always)]
    pub fn is_1(&self) -> bool {
        *self == Swap::_1
    }
