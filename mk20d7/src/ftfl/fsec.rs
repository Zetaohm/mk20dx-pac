...
pub enum Sec {
    ...
    _01 = 1,
    #[doc = "2: MCU security status is unsecure (The standard shipping condition of the FTFL is unsecure.)"]
    _10 = 2,
...
impl SecR {
    ...
    #[doc = "MCU security status is unsecure (The standard shipping condition of the FTFL is unsecure.)"]
    #[inline(always)]
