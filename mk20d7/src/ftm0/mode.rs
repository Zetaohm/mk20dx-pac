...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ftmen(&mut self) -> FtmenW<ModeSpec> {
        FtmenW::new(self, 0)
    }
    #[doc = "Bit 1 - Initialize the Channels Output"]
    #[inline(always)]
    #[must_use]
    pub fn init(&mut self) -> InitW<ModeSpec> {
        InitW::new(self, 1)
    }
    #[doc = "Bit 2 - Write Protection Disable"]
    #[inline(always)]
    #[must_use]
    pub fn wpdis(&mut self) -> WpdisW<ModeSpec> {
        WpdisW::new(self, 2)
    }
    #[doc = "Bit 3 - PWM Synchronization Mode"]
    #[inline(always)]
    #[must_use]
    pub fn pwmsync(&mut self) -> PwmsyncW<ModeSpec> {
        PwmsyncW::new(self, 3)
    }
    #[doc = "Bit 4 - Capture Test Mode Enable"]
    #[inline(always)]
    #[must_use]
    pub fn captest(&mut self) -> CaptestW<ModeSpec> {
        CaptestW::new(self, 4)
    }
    #[doc = "Bits 5:6 - Fault Control Mode"]
    #[inline(always)]
    #[must_use]
    pub fn faultm(&mut self) -> FaultmW<ModeSpec> {
        FaultmW::new(self, 5)
    }
    #[doc = "Bit 7 - Fault Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn faultie(&mut self) -> FaultieW<ModeSpec> {
        FaultieW::new(self, 7)
    }
}
