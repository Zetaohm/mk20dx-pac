...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn div(&mut self) -> DivW<Rcr2Spec> {
        DivW::new(self, 0)
    }
    #[doc = "Bit 24 - Bit clock direction"]
    #[inline(always)]
    #[must_use]
    pub fn bcd(&mut self) -> BcdW<Rcr2Spec> {
        BcdW::new(self, 24)
    }
    #[doc = "Bit 25 - Bit clock polarity"]
    #[inline(always)]
    #[must_use]
    pub fn bcp(&mut self) -> BcpW<Rcr2Spec> {
        BcpW::new(self, 25)
    }
    #[doc = "Bits 26:27 - MCLK Select"]
    #[inline(always)]
    #[must_use]
    pub fn msel(&mut self) -> MselW<Rcr2Spec> {
        MselW::new(self, 26)
    }
    #[doc = "Bit 28 - Bit Clock Input"]
    #[inline(always)]
    #[must_use]
    pub fn bci(&mut self) -> BciW<Rcr2Spec> {
        BciW::new(self, 28)
    }
    #[doc = "Bit 29 - Bit Clock Swap"]
    #[inline(always)]
    #[must_use]
    pub fn bcs(&mut self) -> BcsW<Rcr2Spec> {
        BcsW::new(self, 29)
    }
    #[doc = "Bits 30:31 - Synchronous Mode"]
    #[inline(always)]
    #[must_use]
    pub fn sync(&mut self) -> SyncW<Rcr2Spec> {
        SyncW::new(self, 30)
    }
}
