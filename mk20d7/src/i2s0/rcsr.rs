...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn frde(&mut self) -> FrdeW<RcsrSpec> {
        FrdeW::new(self, 0)
    }
    #[doc = "Bit 1 - FIFO warning DMA enable"]
    #[inline(always)]
    #[must_use]
    pub fn fwde(&mut self) -> FwdeW<RcsrSpec> {
        FwdeW::new(self, 1)
    }
    #[doc = "Bit 8 - FIFO request interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn frie(&mut self) -> FrieW<RcsrSpec> {
        FrieW::new(self, 8)
    }
    #[doc = "Bit 9 - FIFO warning interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn fwie(&mut self) -> FwieW<RcsrSpec> {
        FwieW::new(self, 9)
    }
    #[doc = "Bit 10 - FIFO error interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn feie(&mut self) -> FeieW<RcsrSpec> {
        FeieW::new(self, 10)
    }
    #[doc = "Bit 11 - Sync error interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn seie(&mut self) -> SeieW<RcsrSpec> {
        SeieW::new(self, 11)
    }
    #[doc = "Bit 12 - Word start interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn wsie(&mut self) -> WsieW<RcsrSpec> {
        WsieW::new(self, 12)
    }
    #[doc = "Bit 18 - FIFO error flag"]
    #[inline(always)]
    #[must_use]
    pub fn fef(&mut self) -> FefW<RcsrSpec> {
        FefW::new(self, 18)
    }
    #[doc = "Bit 19 - Sync error flag"]
    #[inline(always)]
    #[must_use]
    pub fn sef(&mut self) -> SefW<RcsrSpec> {
        SefW::new(self, 19)
    }
    #[doc = "Bit 20 - Word start flag"]
    #[inline(always)]
    #[must_use]
    pub fn wsf(&mut self) -> WsfW<RcsrSpec> {
        WsfW::new(self, 20)
    }
    #[doc = "Bit 24 - Software reset"]
    #[inline(always)]
    #[must_use]
    pub fn sr(&mut self) -> SrW<RcsrSpec> {
        SrW::new(self, 24)
    }
    #[doc = "Bit 25 - FIFO reset"]
    #[inline(always)]
    #[must_use]
    pub fn fr(&mut self) -> FrW<RcsrSpec> {
        FrW::new(self, 25)
    }
    #[doc = "Bit 28 - Bit Clock enable"]
    #[inline(always)]
    #[must_use]
    pub fn bce(&mut self) -> BceW<RcsrSpec> {
        BceW::new(self, 28)
    }
    #[doc = "Bit 29 - Debug enable"]
    #[inline(always)]
    #[must_use]
    pub fn dbge(&mut self) -> DbgeW<RcsrSpec> {
        DbgeW::new(self, 29)
    }
    #[doc = "Bit 30 - Stop enable"]
    #[inline(always)]
    #[must_use]
    pub fn stope(&mut self) -> StopeW<RcsrSpec> {
        StopeW::new(self, 30)
    }
    #[doc = "Bit 31 - Receiver enable"]
    #[inline(always)]
    #[must_use]
    pub fn re(&mut self) -> ReW<RcsrSpec> {
        ReW::new(self, 31)
    }
}
