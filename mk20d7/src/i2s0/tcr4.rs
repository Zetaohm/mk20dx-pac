...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn fsd(&mut self) -> FsdW<Tcr4Spec> {
        FsdW::new(self, 0)
    }
    #[doc = "Bit 1 - Frame sync polarity"]
    #[inline(always)]
    #[must_use]
    pub fn fsp(&mut self) -> FspW<Tcr4Spec> {
        FspW::new(self, 1)
    }
    #[doc = "Bit 3 - Frame sync early"]
    #[inline(always)]
    #[must_use]
    pub fn fse(&mut self) -> FseW<Tcr4Spec> {
        FseW::new(self, 3)
    }
    #[doc = "Bit 4 - MSB first"]
    #[inline(always)]
    #[must_use]
    pub fn mf(&mut self) -> MfW<Tcr4Spec> {
        MfW::new(self, 4)
    }
    #[doc = "Bits 8:12 - Sync width"]
    #[inline(always)]
    #[must_use]
    pub fn sywd(&mut self) -> SywdW<Tcr4Spec> {
        SywdW::new(self, 8)
    }
    #[doc = "Bits 16:20 - Frame size"]
    #[inline(always)]
    #[must_use]
    pub fn frsz(&mut self) -> FrszW<Tcr4Spec> {
        FrszW::new(self, 16)
    }
}
