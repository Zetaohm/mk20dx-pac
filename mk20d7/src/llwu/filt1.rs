...
pub type R = crate::R<Filt1Spec>;
#[doc = "Register `FILT1` writer"]
pub type W = crate::W<Filt1Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn filtsel(&mut self) -> FiltselW<Filt1Spec> {
        FiltselW::new(self, 0)
    }
    #[doc = "Bits 5:6 - Digital Filter on External Pin"]
    #[inline(always)]
    #[must_use]
    pub fn filte(&mut self) -> FilteW<Filt1Spec> {
        FilteW::new(self, 5)
    }
    #[doc = "Bit 7 - Filter Detect Flag"]
    #[inline(always)]
    #[must_use]
    pub fn filtf(&mut self) -> FiltfW<Filt1Spec> {
        FiltfW::new(self, 7)
    }
}
#[doc = "LLWU Pin Filter 1 Register\n\nYou can [`read`](crate::Reg::read) this register and get [`filt1::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`filt1::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Filt1Spec;
impl crate::RegisterSpec for Filt1Spec {
    type Ux = u8;
}
#[doc = "`read()` method returns [`filt1::R`](R) reader structure"]
impl crate::Readable for Filt1Spec {}
#[doc = "`write(|w| ..)` method takes [`filt1::W`](W) writer structure"]
impl crate::Writable for Filt1Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u8 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u8 = 0;
}
#[doc = "`reset()` method sets FILT1 to value 0"]
impl crate::Resettable for Filt1Spec {
