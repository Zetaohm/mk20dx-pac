...
pub mod ier;
#[doc = "WAR (rw) register accessor: RTC Write Access Register\n\nYou can [`read`](crate::Reg::read) this register and get [`war::R`]. You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`war::W`]. You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@war`]
module"]
#[doc(alias = "WAR")]
pub type War = crate::Reg<war::WarSpec>;
#[doc = "RTC Write Access Register"]
pub mod war;
#[doc = "RAR (rw) register accessor: RTC Read Access Register\n\nYou can [`read`](crate::Reg::read) this register and get [`rar::R`]. You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`rar::W`]. You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@rar`]
module"]
#[doc(alias = "RAR")]
