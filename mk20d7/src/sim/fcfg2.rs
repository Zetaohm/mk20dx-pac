...
impl From<Swappflsh> for bool {
    #[inline(always)]
    fn from(variant: Swappflsh) -> Self {
        variant as u8 != 0
    }
}
#[doc = "Field `SWAPPFLSH` reader - Swap program flash"]
pub type SwappflshR = crate::BitReader<Swappflsh>;
impl SwappflshR {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> Swappflsh {
        match self.bits {
            false => Swappflsh::_0,
            true => Swappflsh::_1,
        }
...
impl R {
    ...
    pub fn swappflsh(&self) -> SwappflshR {
        SwappflshR::new(((self.bits >> 31) & 1) != 0)
    }
}
