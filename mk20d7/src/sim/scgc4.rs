    ...
    REG: crate::Writable + crate::RegisterSpec,
{
    ...
    #[inline(always)]
    pub fn _0(self) -> &'a mut crate::W<REG> {
        self.variant(I2c1::_0)
    }
    #[doc = "Clock enabled"]
    #[inline(always)]
    pub fn _1(self) -> &'a mut crate::W<REG> {
        self.variant(I2c1::_1)
    }
}
...
impl From<Uart3> for bool {
    #[inline(always)]
    fn from(variant: Uart3) -> Self {
        variant as u8 != 0
    }
}
#[doc = "Field `UART3` reader - UART3 Clock Gate Control"]
pub type Uart3R = crate::BitReader<Uart3>;
impl Uart3R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> Uart3 {
        match self.bits {
            false => Uart3::_0,
            true => Uart3::_1,
        }
...
pub type Uart3W<'a, REG> = crate::BitWriter<'a, REG, Uart3>;
impl<'a, REG> Uart3W<'a, REG>
where
    REG: crate::Writable + crate::RegisterSpec,
{
    #[doc = "Clock disabled"]
    #[inline(always)]
    pub fn _0(self) -> &'a mut crate::W<REG> {
        self.variant(Uart3::_0)
    }
    #[doc = "Clock enabled"]
    #[inline(always)]
    pub fn _1(self) -> &'a mut crate::W<REG> {
        self.variant(Uart3::_1)
    }
}
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn uart3(&mut self) -> Uart3W<Scgc4Spec> {
        Uart3W::new(self, 13)
    }
    #[doc = "Bit 18 - USB Clock Gate Control"]
    #[inline(always)]
