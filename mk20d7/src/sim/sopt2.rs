...
impl From<Fbsl> for u8 {
    #[inline(always)]
    fn from(variant: Fbsl) -> Self {
        variant as _
    }
}
impl crate::FieldSpec for Fbsl {
    type Ux = u8;
}
impl crate::IsEnum for Fbsl {}
#[doc = "Field `FBSL` reader - FlexBus security level"]
pub type FbslR = crate::FieldReader<Fbsl>;
impl FbslR {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> Fbsl {
        match self.bits {
            0 => Fbsl::_00,
            1 => Fbsl::_01,
            2 => Fbsl::_10,
...
pub type FbslW<'a, REG> = crate::FieldWriter<'a, REG, 2, Fbsl, crate::Safe>;
impl<'a, REG> FbslW<'a, REG>
where
    REG: crate::Writable + crate::RegisterSpec,
    REG::Ux: From<u8>,
{
    ...
    pub fn _00(self) -> &'a mut crate::W<REG> {
        self.variant(Fbsl::_00)
    }
    #[doc = "All off-chip accesses (instruction and data) via the FlexBus are disallowed."]
    #[inline(always)]
    pub fn _01(self) -> &'a mut crate::W<REG> {
        self.variant(Fbsl::_01)
    }
    #[doc = "Off-chip instruction accesses are disallowed. Data accesses are allowed."]
    #[inline(always)]
    pub fn _10(self) -> &'a mut crate::W<REG> {
        self.variant(Fbsl::_10)
    }
    #[doc = "Off-chip instruction accesses and data accesses are allowed."]
    #[inline(always)]
    pub fn _11(self) -> &'a mut crate::W<REG> {
        self.variant(Fbsl::_11)
    }
}
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn fbsl(&mut self) -> FbslW<Sopt2Spec> {
        FbslW::new(self, 8)
    }
    #[doc = "Bit 11 - PTD7 pad drive strength"]
    #[inline(always)]
