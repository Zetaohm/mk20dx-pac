...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ftm0flt0(&mut self) -> Ftm0flt0W<Sopt4Spec> {
        Ftm0flt0W::new(self, 0)
    }
    #[doc = "Bit 1 - FTM0 Fault 1 Select"]
    #[inline(always)]
    #[must_use]
    pub fn ftm0flt1(&mut self) -> Ftm0flt1W<Sopt4Spec> {
        Ftm0flt1W::new(self, 1)
    }
    #[doc = "Bit 2 - FTM0 Fault 2 Select"]
    #[inline(always)]
    #[must_use]
    pub fn ftm0flt2(&mut self) -> Ftm0flt2W<Sopt4Spec> {
        Ftm0flt2W::new(self, 2)
    }
    #[doc = "Bit 4 - FTM1 Fault 0 Select"]
    #[inline(always)]
    #[must_use]
    pub fn ftm1flt0(&mut self) -> Ftm1flt0W<Sopt4Spec> {
        Ftm1flt0W::new(self, 4)
    }
    #[doc = "Bit 8 - FTM2 Fault 0 Select"]
    #[inline(always)]
    #[must_use]
    pub fn ftm2flt0(&mut self) -> Ftm2flt0W<Sopt4Spec> {
        Ftm2flt0W::new(self, 8)
    }
    #[doc = "Bits 18:19 - FTM1 channel 0 input capture source select"]
    #[inline(always)]
    #[must_use]
    pub fn ftm1ch0src(&mut self) -> Ftm1ch0srcW<Sopt4Spec> {
        Ftm1ch0srcW::new(self, 18)
    }
    #[doc = "Bits 20:21 - FTM2 channel 0 input capture source select"]
    #[inline(always)]
    #[must_use]
    pub fn ftm2ch0src(&mut self) -> Ftm2ch0srcW<Sopt4Spec> {
        Ftm2ch0srcW::new(self, 20)
    }
    #[doc = "Bit 24 - FlexTimer 0 External Clock Pin Select"]
    #[inline(always)]
    #[must_use]
    pub fn ftm0clksel(&mut self) -> Ftm0clkselW<Sopt4Spec> {
        Ftm0clkselW::new(self, 24)
    }
    #[doc = "Bit 25 - FTM1 External Clock Pin Select"]
    #[inline(always)]
    #[must_use]
    pub fn ftm1clksel(&mut self) -> Ftm1clkselW<Sopt4Spec> {
        Ftm1clkselW::new(self, 25)
    }
    #[doc = "Bit 26 - FlexTimer 2 External Clock Pin Select"]
    #[inline(always)]
    #[must_use]
    pub fn ftm2clksel(&mut self) -> Ftm2clkselW<Sopt4Spec> {
        Ftm2clkselW::new(self, 26)
    }
    #[doc = "Bit 28 - FlexTimer 0 Hardware Trigger 0 Source Select"]
    #[inline(always)]
    #[must_use]
    pub fn ftm0trg0src(&mut self) -> Ftm0trg0srcW<Sopt4Spec> {
        Ftm0trg0srcW::new(self, 28)
    }
    #[doc = "Bit 29 - FlexTimer 0 Hardware Trigger 1 Source Select"]
    #[inline(always)]
    #[must_use]
    pub fn ftm0trg1src(&mut self) -> Ftm0trg1srcW<Sopt4Spec> {
