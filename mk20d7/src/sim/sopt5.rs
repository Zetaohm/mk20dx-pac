...
impl Uart0txsrcR {
    ...
    pub const fn variant(&self) -> Option<Uart0txsrc> {
        match self.bits {
            0 => Some(Uart0txsrc::_00),
            1 => Some(Uart0txsrc::_01),
            2 => Some(Uart0txsrc::_10),
            _ => None,
        }
    }
    #[doc = "UART0_TX pin"]
    ...
    REG::Ux: From<u8>,
{
    ...
    pub fn _00(self) -> &'a mut crate::W<REG> {
        self.variant(Uart0txsrc::_00)
    }
    #[doc = "UART0_TX pin modulated with FTM1 channel 0 output"]
    #[inline(always)]
    pub fn _01(self) -> &'a mut crate::W<REG> {
        self.variant(Uart0txsrc::_01)
    }
    #[doc = "UART0_TX pin modulated with FTM2 channel 0 output"]
    #[inline(always)]
    pub fn _10(self) -> &'a mut crate::W<REG> {
        self.variant(Uart0txsrc::_10)
    }
}
...
impl Uart1txsrcR {
    ...
    pub const fn variant(&self) -> Option<Uart1txsrc> {
        match self.bits {
            0 => Some(Uart1txsrc::_00),
            1 => Some(Uart1txsrc::_01),
            2 => Some(Uart1txsrc::_10),
            _ => None,
        }
    }
    #[doc = "UART1_TX pin"]
    ...
    REG::Ux: From<u8>,
{
    ...
    #[inline(always)]
    pub fn _00(self) -> &'a mut crate::W<REG> {
        self.variant(Uart1txsrc::_00)
    }
    #[doc = "UART1_TX pin modulated with FTM1 channel 0 output"]
    #[inline(always)]
    pub fn _01(self) -> &'a mut crate::W<REG> {
        self.variant(Uart1txsrc::_01)
    }
    #[doc = "UART1_TX pin modulated with FTM2 channel 0 output"]
    #[inline(always)]
    pub fn _10(self) -> &'a mut crate::W<REG> {
        self.variant(Uart1txsrc::_10)
    }
}
