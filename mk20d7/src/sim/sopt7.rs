...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn adc1trgsel(&mut self) -> Adc1trgselW<Sopt7Spec> {
        Adc1trgselW::new(self, 8)
    }
    #[doc = "Bit 12 - ADC1 pre-trigger select"]
    #[inline(always)]
    #[must_use]
    pub fn adc1pretrgsel(&mut self) -> Adc1pretrgselW<Sopt7Spec> {
        Adc1pretrgselW::new(self, 12)
    }
    #[doc = "Bit 15 - ADC1 alternate trigger enable"]
    #[inline(always)]
    #[must_use]
    pub fn adc1alttrgen(&mut self) -> Adc1alttrgenW<Sopt7Spec> {
