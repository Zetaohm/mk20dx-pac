    ...
    REG: crate::Writable + crate::RegisterSpec,
{
    ...
    #[inline(always)]
    pub fn _0(self) -> &'a mut crate::W<REG> {
        self.variant(ClrRxf::_0)
    }
    #[doc = "Clear the Rx FIFO counter."]
    #[inline(always)]
    pub fn _1(self) -> &'a mut crate::W<REG> {
        self.variant(ClrRxf::_1)
    }
}
#[doc = "Clear TX FIFO\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
    ...
    REG: crate::Writable + crate::RegisterSpec,
{
    ...
    #[inline(always)]
    pub fn _0(self) -> &'a mut crate::W<REG> {
        self.variant(ClrTxf::_0)
    }
    #[doc = "Clear the Tx FIFO counter."]
    #[inline(always)]
    pub fn _1(self) -> &'a mut crate::W<REG> {
        self.variant(ClrTxf::_1)
    }
}
    ...
    REG: crate::Writable + crate::RegisterSpec,
{
    ...
    #[inline(always)]
    pub fn _0(self) -> &'a mut crate::W<REG> {
        self.variant(DisRxf::_0)
    }
    #[doc = "Rx FIFO is disabled."]
    #[inline(always)]
    pub fn _1(self) -> &'a mut crate::W<REG> {
        self.variant(DisRxf::_1)
    }
}
    ...
    REG: crate::Writable + crate::RegisterSpec,
{
    ...
    #[inline(always)]
    pub fn _0(self) -> &'a mut crate::W<REG> {
        self.variant(DisTxf::_0)
    }
    #[doc = "Tx FIFO is disabled."]
    #[inline(always)]
    pub fn _1(self) -> &'a mut crate::W<REG> {
        self.variant(DisTxf::_1)
    }
}
#[doc = "Module Disable\n\nValue on reset: 1"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
    ...
    REG: crate::Writable + crate::RegisterSpec,
{
    ...
    #[inline(always)]
    pub fn _0(self) -> &'a mut crate::W<REG> {
        self.variant(Doze::_0)
    }
    #[doc = "Doze mode disables DSPI."]
    #[inline(always)]
    pub fn _1(self) -> &'a mut crate::W<REG> {
        self.variant(Doze::_1)
    }
}
    ...
    REG: crate::Writable + crate::RegisterSpec,
{
    ...
    #[inline(always)]
    pub fn _0(self) -> &'a mut crate::W<REG> {
        self.variant(Rooe::_0)
    }
    #[doc = "Incoming data is shifted into the shift register."]
    #[inline(always)]
    pub fn _1(self) -> &'a mut crate::W<REG> {
        self.variant(Rooe::_1)
    }
}
...
signal."]
    #[inline(always)]
    pub fn _0(self) -> &'a mut crate::W<REG> {
        self.variant(Pcsse::_0)
    }
    #[doc = "PCS\\[5\\]/PCSS is used as an active-low PCS Strobe signal."]
    #[inline(always)]
    pub fn _1(self) -> &'a mut crate::W<REG> {
        self.variant(Pcsse::_1)
    }
}
    ...
    REG: crate::Writable + crate::RegisterSpec,
{
    ...
    #[inline(always)]
    pub fn _0(self) -> &'a mut crate::W<REG> {
        self.variant(Mtfe::_0)
    }
    #[doc = "Modified SPI transfer format enabled."]
    #[inline(always)]
    pub fn _1(self) -> &'a mut crate::W<REG> {
        self.variant(Mtfe::_1)
    }
}
#[doc = "Freeze\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
    ...
    REG: crate::Writable + crate::RegisterSpec,
{
    ...
    #[inline(always)]
    pub fn _0(self) -> &'a mut crate::W<REG> {
        self.variant(ContScke::_0)
    }
    #[doc = "Continuous SCK enabled."]
    #[inline(always)]
    pub fn _1(self) -> &'a mut crate::W<REG> {
        self.variant(ContScke::_1)
    }
}
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn smpl_pt(&mut self) -> SmplPtW<McrSpec> {
        SmplPtW::new(self, 8)
    }
    #[doc = "Bit 10 - no description available"]
    #[inline(always)]
    #[must_use]
    pub fn clr_rxf(&mut self) -> ClrRxfW<McrSpec> {
        ClrRxfW::new(self, 10)
    }
    #[doc = "Bit 11 - Clear TX FIFO"]
    #[inline(always)]
    #[must_use]
    pub fn clr_txf(&mut self) -> ClrTxfW<McrSpec> {
        ClrTxfW::new(self, 11)
    }
    #[doc = "Bit 12 - Disable Receive FIFO"]
    #[inline(always)]
    #[must_use]
    pub fn dis_rxf(&mut self) -> DisRxfW<McrSpec> {
        DisRxfW::new(self, 12)
    }
    #[doc = "Bit 13 - Disable Transmit FIFO"]
    #[inline(always)]
    #[must_use]
    pub fn dis_txf(&mut self) -> DisTxfW<McrSpec> {
        DisTxfW::new(self, 13)
    }
    #[doc = "Bit 14 - Module Disable"]
    #[inline(always)]
    ...
    #[inline(always)]
    #[must_use]
    pub fn pcsis(&mut self) -> PcsisW<McrSpec> {
        PcsisW::new(self, 16)
    }
    #[doc = "Bit 24 - Receive FIFO Overflow Overwrite Enable"]
    #[inline(always)]
    #[must_use]
    pub fn rooe(&mut self) -> RooeW<McrSpec> {
        RooeW::new(self, 24)
    }
    #[doc = "Bit 25 - Peripheral Chip Select Strobe Enable"]
    #[inline(always)]
    #[must_use]
    pub fn pcsse(&mut self) -> PcsseW<McrSpec> {
        PcsseW::new(self, 25)
    }
    #[doc = "Bit 26 - Modified Timing Format Enable"]
    #[inline(always)]
    #[must_use]
    pub fn mtfe(&mut self) -> MtfeW<McrSpec> {
        MtfeW::new(self, 26)
    }
    #[doc = "Bit 27 - Freeze"]
    #[inline(always)]
    ...
    #[inline(always)]
    #[must_use]
    pub fn dconf(&mut self) -> DconfW<McrSpec> {
        DconfW::new(self, 28)
    }
    #[doc = "Bit 30 - Continuous SCK Enable"]
    #[inline(always)]
    #[must_use]
    pub fn cont_scke(&mut self) -> ContSckeW<McrSpec> {
        ContSckeW::new(self, 30)
    }
    #[doc = "Bit 31 - Master/Slave Mode Select"]
    #[inline(always)]
    #[must_use]
    pub fn mstr(&mut self) -> MstrW<McrSpec> {
        MstrW::new(self, 31)
    }
}
