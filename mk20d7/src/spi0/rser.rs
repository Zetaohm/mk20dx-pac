    ...
    REG: crate::Writable + crate::RegisterSpec,
{
    ...
    pub fn _0(self) -> &'a mut crate::W<REG> {
        self.variant(RfdfDirs::_0)
    }
    #[doc = "DMA request."]
    #[inline(always)]
    pub fn _1(self) -> &'a mut crate::W<REG> {
        self.variant(RfdfDirs::_1)
    }
}
    ...
    REG: crate::Writable + crate::RegisterSpec,
{
    ...
    #[inline(always)]
    pub fn _0(self) -> &'a mut crate::W<REG> {
        self.variant(RfdfRe::_0)
    }
    #[doc = "RFDF interrupt or DMA requests are enabled"]
    #[inline(always)]
    pub fn _1(self) -> &'a mut crate::W<REG> {
        self.variant(RfdfRe::_1)
    }
}
    ...
    REG: crate::Writable + crate::RegisterSpec,
{
    ...
    #[inline(always)]
    pub fn _0(self) -> &'a mut crate::W<REG> {
        self.variant(RfofRe::_0)
    }
    #[doc = "RFOF interrupt requests are enabled."]
    #[inline(always)]
    pub fn _1(self) -> &'a mut crate::W<REG> {
        self.variant(RfofRe::_1)
    }
}
    ...
    REG: crate::Writable + crate::RegisterSpec,
{
    ...
    #[inline(always)]
    pub fn _0(self) -> &'a mut crate::W<REG> {
        self.variant(TfffDirs::_0)
    }
    #[doc = "TFFF flag generates DMA requests."]
    #[inline(always)]
    pub fn _1(self) -> &'a mut crate::W<REG> {
        self.variant(TfffDirs::_1)
    }
}
    ...
    REG: crate::Writable + crate::RegisterSpec,
{
    ...
    #[inline(always)]
    pub fn _0(self) -> &'a mut crate::W<REG> {
        self.variant(TfffRe::_0)
    }
    #[doc = "TFFF interrupts or DMA requests are enabled."]
    #[inline(always)]
    pub fn _1(self) -> &'a mut crate::W<REG> {
        self.variant(TfffRe::_1)
    }
}
    ...
    REG: crate::Writable + crate::RegisterSpec,
{
    ...
    #[inline(always)]
    pub fn _0(self) -> &'a mut crate::W<REG> {
        self.variant(TfufRe::_0)
    }
    #[doc = "TFUF interrupt requests are enabled."]
    #[inline(always)]
    pub fn _1(self) -> &'a mut crate::W<REG> {
        self.variant(TfufRe::_1)
    }
}
    ...
    REG: crate::Writable + crate::RegisterSpec,
{
    ...
    #[inline(always)]
    pub fn _0(self) -> &'a mut crate::W<REG> {
        self.variant(EoqfRe::_0)
    }
    #[doc = "EOQF interrupt requests are enabled."]
    #[inline(always)]
    pub fn _1(self) -> &'a mut crate::W<REG> {
        self.variant(EoqfRe::_1)
    }
}
    ...
    REG: crate::Writable + crate::RegisterSpec,
{
    ...
    #[inline(always)]
    pub fn _0(self) -> &'a mut crate::W<REG> {
        self.variant(TcfRe::_0)
    }
    #[doc = "TCF interrupt requests are enabled."]
    #[inline(always)]
    pub fn _1(self) -> &'a mut crate::W<REG> {
        self.variant(TcfRe::_1)
    }
}
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn rfdf_dirs(&mut self) -> RfdfDirsW<RserSpec> {
        RfdfDirsW::new(self, 16)
    }
    #[doc = "Bit 17 - Receive FIFO Drain Request Enable"]
    #[inline(always)]
    #[must_use]
    pub fn rfdf_re(&mut self) -> RfdfReW<RserSpec> {
        RfdfReW::new(self, 17)
    }
    #[doc = "Bit 19 - Receive FIFO Overflow Request Enable"]
    #[inline(always)]
    #[must_use]
    pub fn rfof_re(&mut self) -> RfofReW<RserSpec> {
        RfofReW::new(self, 19)
    }
    #[doc = "Bit 24 - Transmit FIFO Fill DMA or Interrupt Request Select"]
    #[inline(always)]
    #[must_use]
    pub fn tfff_dirs(&mut self) -> TfffDirsW<RserSpec> {
        TfffDirsW::new(self, 24)
    }
    #[doc = "Bit 25 - Transmit FIFO Fill Request Enable"]
    #[inline(always)]
    #[must_use]
    pub fn tfff_re(&mut self) -> TfffReW<RserSpec> {
        TfffReW::new(self, 25)
    }
    #[doc = "Bit 27 - Transmit FIFO Underflow Request Enable"]
    #[inline(always)]
    #[must_use]
    pub fn tfuf_re(&mut self) -> TfufReW<RserSpec> {
        TfufReW::new(self, 27)
    }
    #[doc = "Bit 28 - DSPI Finished Request Enable"]
    #[inline(always)]
    #[must_use]
    pub fn eoqf_re(&mut self) -> EoqfReW<RserSpec> {
        EoqfReW::new(self, 28)
    }
    #[doc = "Bit 31 - Transmission Complete Request Enable"]
    #[inline(always)]
    #[must_use]
    pub fn tcf_re(&mut self) -> TcfReW<RserSpec> {
        TcfReW::new(self, 31)
    }
}
