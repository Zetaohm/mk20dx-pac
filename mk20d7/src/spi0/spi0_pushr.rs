...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn txdata(&mut self) -> TxdataW<Spi0PushrSpec> {
        TxdataW::new(self, 0)
    }
    #[doc = "Bits 16:21 - no description available"]
    #[inline(always)]
    #[must_use]
    pub fn pcs(&mut self) -> PcsW<Spi0PushrSpec> {
        PcsW::new(self, 16)
    }
    #[doc = "Bit 26 - Clear Transfer Counter."]
    #[inline(always)]
    #[must_use]
    pub fn ctcnt(&mut self) -> CtcntW<Spi0PushrSpec> {
        CtcntW::new(self, 26)
    }
    #[doc = "Bit 27 - End Of Queue"]
    #[inline(always)]
    #[must_use]
    pub fn eoq(&mut self) -> EoqW<Spi0PushrSpec> {
        EoqW::new(self, 27)
    }
    #[doc = "Bits 28:30 - Clock and Transfer Attributes Select."]
    #[inline(always)]
    #[must_use]
    pub fn ctas(&mut self) -> CtasW<Spi0PushrSpec> {
        CtasW::new(self, 28)
    }
    #[doc = "Bit 31 - Continuous Peripheral Chip Select Enable"]
    #[inline(always)]
    #[must_use]
    pub fn cont(&mut self) -> ContW<Spi0PushrSpec> {
        ContW::new(self, 31)
    }
}
