...
pub type R = crate::R<Spi1CtarSpec>;
#[doc = "Register `CTAR%s` writer"]
pub type W = crate::W<Spi1CtarSpec>;
    ...
    REG::Ux: From<u8>,
{
    ...
    pub fn _00(self) -> &'a mut crate::W<REG> {
        self.variant(Pbr::_00)
    }
    #[doc = "Baud Rate Prescaler value is 3."]
    #[inline(always)]
    pub fn _01(self) -> &'a mut crate::W<REG> {
        self.variant(Pbr::_01)
    }
    #[doc = "Baud Rate Prescaler value is 5."]
    #[inline(always)]
    pub fn _10(self) -> &'a mut crate::W<REG> {
        self.variant(Pbr::_10)
    }
    #[doc = "Baud Rate Prescaler value is 7."]
    #[inline(always)]
    pub fn _11(self) -> &'a mut crate::W<REG> {
        self.variant(Pbr::_11)
    }
}
    ...
    REG::Ux: From<u8>,
{
    ...
    #[inline(always)]
    pub fn _00(self) -> &'a mut crate::W<REG> {
        self.variant(Pdt::_00)
    }
    #[doc = "Delay after Transfer Prescaler value is 3."]
    #[inline(always)]
    pub fn _01(self) -> &'a mut crate::W<REG> {
        self.variant(Pdt::_01)
    }
    #[doc = "Delay after Transfer Prescaler value is 5."]
    #[inline(always)]
    pub fn _10(self) -> &'a mut crate::W<REG> {
        self.variant(Pdt::_10)
    }
    #[doc = "Delay after Transfer Prescaler value is 7."]
    #[inline(always)]
    pub fn _11(self) -> &'a mut crate::W<REG> {
        self.variant(Pdt::_11)
    }
}
    ...
    REG::Ux: From<u8>,
{
    ...
    #[inline(always)]
    pub fn _00(self) -> &'a mut crate::W<REG> {
        self.variant(Pasc::_00)
    }
    #[doc = "Delay after Transfer Prescaler value is 3."]
    #[inline(always)]
    pub fn _01(self) -> &'a mut crate::W<REG> {
        self.variant(Pasc::_01)
    }
    #[doc = "Delay after Transfer Prescaler value is 5."]
    #[inline(always)]
    pub fn _10(self) -> &'a mut crate::W<REG> {
        self.variant(Pasc::_10)
    }
    #[doc = "Delay after Transfer Prescaler value is 7."]
    #[inline(always)]
    pub fn _11(self) -> &'a mut crate::W<REG> {
        self.variant(Pasc::_11)
    }
}
    ...
    REG::Ux: From<u8>,
{
    ...
    #[inline(always)]
    pub fn _00(self) -> &'a mut crate::W<REG> {
        self.variant(Pcssck::_00)
    }
    #[doc = "PCS to SCK Prescaler value is 3."]
    #[inline(always)]
    pub fn _01(self) -> &'a mut crate::W<REG> {
        self.variant(Pcssck::_01)
    }
    #[doc = "PCS to SCK Prescaler value is 5."]
    #[inline(always)]
    pub fn _10(self) -> &'a mut crate::W<REG> {
        self.variant(Pcssck::_10)
    }
    #[doc = "PCS to SCK Prescaler value is 7."]
    #[inline(always)]
    pub fn _11(self) -> &'a mut crate::W<REG> {
        self.variant(Pcssck::_11)
    }
}
#[doc = "LBS First\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
    ...
    REG: crate::Writable + crate::RegisterSpec,
{
    ...
    pub fn _0(self) -> &'a mut crate::W<REG> {
        self.variant(Lsbfe::_0)
    }
    #[doc = "Data is transferred LSB first."]
    #[inline(always)]
    pub fn _1(self) -> &'a mut crate::W<REG> {
        self.variant(Lsbfe::_1)
    }
}
#[doc = "Clock Phase\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn br(&mut self) -> BrW<Spi1CtarSpec> {
        BrW::new(self, 0)
    }
    #[doc = "Bits 4:7 - Delay After Transfer Scaler"]
    #[inline(always)]
    #[must_use]
    pub fn dt(&mut self) -> DtW<Spi1CtarSpec> {
        DtW::new(self, 4)
    }
    #[doc = "Bits 8:11 - After SCK Delay Scaler"]
    #[inline(always)]
    #[must_use]
    pub fn asc(&mut self) -> AscW<Spi1CtarSpec> {
        AscW::new(self, 8)
    }
    #[doc = "Bits 12:15 - PCS to SCK Delay Scaler"]
    #[inline(always)]
    #[must_use]
    pub fn cssck(&mut self) -> CssckW<Spi1CtarSpec> {
        CssckW::new(self, 12)
    }
    #[doc = "Bits 16:17 - Baud Rate Prescaler"]
    #[inline(always)]
    #[must_use]
    pub fn pbr(&mut self) -> PbrW<Spi1CtarSpec> {
        PbrW::new(self, 16)
    }
    #[doc = "Bits 18:19 - Delay after Transfer Prescaler"]
    #[inline(always)]
    #[must_use]
    pub fn pdt(&mut self) -> PdtW<Spi1CtarSpec> {
        PdtW::new(self, 18)
    }
    #[doc = "Bits 20:21 - After SCK Delay Prescaler"]
    #[inline(always)]
    #[must_use]
    pub fn pasc(&mut self) -> PascW<Spi1CtarSpec> {
        PascW::new(self, 20)
    }
    #[doc = "Bits 22:23 - PCS to SCK Delay Prescaler"]
    #[inline(always)]
    #[must_use]
    pub fn pcssck(&mut self) -> PcssckW<Spi1CtarSpec> {
        PcssckW::new(self, 22)
    }
    #[doc = "Bit 24 - LBS First"]
    #[inline(always)]
    #[must_use]
    pub fn lsbfe(&mut self) -> LsbfeW<Spi1CtarSpec> {
        LsbfeW::new(self, 24)
    }
    #[doc = "Bit 25 - Clock Phase"]
    #[inline(always)]
    #[must_use]
    pub fn cpha(&mut self) -> CphaW<Spi1CtarSpec> {
        CphaW::new(self, 25)
    }
    #[doc = "Bit 26 - Clock Polarity"]
    #[inline(always)]
    #[must_use]
    pub fn cpol(&mut self) -> CpolW<Spi1CtarSpec> {
        CpolW::new(self, 26)
    }
    #[doc = "Bits 27:30 - Frame Size"]
    #[inline(always)]
    #[must_use]
    pub fn fmsz(&mut self) -> FmszW<Spi1CtarSpec> {
        FmszW::new(self, 27)
    }
    #[doc = "Bit 31 - Double Baud Rate"]
    #[inline(always)]
    #[must_use]
    pub fn dbr(&mut self) -> DbrW<Spi1CtarSpec> {
        DbrW::new(self, 31)
    }
}
#[doc = "DSPI Clock and Transfer Attributes Register (In Master Mode)\n\nYou can [`read`](crate::Reg::read) this register and get [`spi1_ctar::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`spi1_ctar::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Spi1CtarSpec;
impl crate::RegisterSpec for Spi1CtarSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`spi1_ctar::R`](R) reader structure"]
impl crate::Readable for Spi1CtarSpec {}
#[doc = "`write(|w| ..)` method takes [`spi1_ctar::W`](W) writer structure"]
impl crate::Writable for Spi1CtarSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets CTAR%s to value 0x7800_0000"]
impl crate::Resettable for Spi1CtarSpec {
