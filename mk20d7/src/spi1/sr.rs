    ...
    REG: crate::Writable + crate::RegisterSpec,
{
    ...
    pub fn _0(self) -> &'a mut crate::W<REG> {
        self.variant(Rfdf::_0)
    }
    #[doc = "Rx FIFO is not empty."]
    #[inline(always)]
    pub fn _1(self) -> &'a mut crate::W<REG> {
        self.variant(Rfdf::_1)
    }
}
    ...
    REG: crate::Writable + crate::RegisterSpec,
{
    ...
    #[inline(always)]
    pub fn _0(self) -> &'a mut crate::W<REG> {
        self.variant(Tfff::_0)
    }
    #[doc = "Tx FIFO is not full."]
    #[inline(always)]
    pub fn _1(self) -> &'a mut crate::W<REG> {
        self.variant(Tfff::_1)
    }
}
    ...
    REG: crate::Writable + crate::RegisterSpec,
{
    ...
    #[inline(always)]
    pub fn _0(self) -> &'a mut crate::W<REG> {
        self.variant(Eoqf::_0)
    }
    #[doc = "EOQ is set in the executing SPI command."]
    #[inline(always)]
    pub fn _1(self) -> &'a mut crate::W<REG> {
        self.variant(Eoqf::_1)
    }
}
#[doc = "TX and RX Status\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum Txrxs {
    #[doc = "0: Transmit and receive operations are disabled (DSPI is in stopped state)."]
    _0 = 0,
    #[doc = "1: Transmit and receive operations are enabled (DSPI is in running state)."]
    _1 = 1,
}
...
impl TxrxsR {
    ...
    #[doc = "Transmit and receive operations are disabled (DSPI is in stopped state)."]
    #[inline(always)]
    pub fn is_0(&self) -> bool {
        *self == Txrxs::_0
    }
    #[doc = "Transmit and receive operations are enabled (DSPI is in running state)."]
    #[inline(always)]
    pub fn is_1(&self) -> bool {
        *self == Txrxs::_1
    }
    ...
    REG: crate::Writable + crate::RegisterSpec,
{
    ...
    #[inline(always)]
    pub fn _0(self) -> &'a mut crate::W<REG> {
        self.variant(Txrxs::_0)
    }
    #[doc = "Transmit and receive operations are enabled (DSPI is in running state)."]
    #[inline(always)]
    pub fn _1(self) -> &'a mut crate::W<REG> {
        self.variant(Txrxs::_1)
    }
}
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn rfdf(&mut self) -> RfdfW<SrSpec> {
        RfdfW::new(self, 17)
    }
    #[doc = "Bit 19 - Receive FIFO Overflow Flag"]
    #[inline(always)]
    #[must_use]
    pub fn rfof(&mut self) -> RfofW<SrSpec> {
        RfofW::new(self, 19)
    }
    #[doc = "Bit 25 - Transmit FIFO Fill Flag"]
    #[inline(always)]
    #[must_use]
    pub fn tfff(&mut self) -> TfffW<SrSpec> {
        TfffW::new(self, 25)
    }
    #[doc = "Bit 27 - Transmit FIFO Underflow Flag"]
    #[inline(always)]
    #[must_use]
    pub fn tfuf(&mut self) -> TfufW<SrSpec> {
        TfufW::new(self, 27)
    }
    #[doc = "Bit 28 - End of Queue Flag"]
    #[inline(always)]
    #[must_use]
    pub fn eoqf(&mut self) -> EoqfW<SrSpec> {
        EoqfW::new(self, 28)
    }
    #[doc = "Bit 30 - TX and RX Status"]
    #[inline(always)]
    #[must_use]
    pub fn txrxs(&mut self) -> TxrxsW<SrSpec> {
        TxrxsW::new(self, 30)
    }
    #[doc = "Bit 31 - Transfer Complete Flag"]
    #[inline(always)]
