...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn pen0(&mut self) -> Pen0W<PenSpec> {
        Pen0W::new(self, 0)
    }
    #[doc = "Bit 1 - Touch Sensing Input Pin Enable Register 1"]
    #[inline(always)]
    #[must_use]
    pub fn pen1(&mut self) -> Pen1W<PenSpec> {
        Pen1W::new(self, 1)
    }
    #[doc = "Bit 2 - Touch Sensing Input Pin Enable Register 2"]
    #[inline(always)]
    #[must_use]
    pub fn pen2(&mut self) -> Pen2W<PenSpec> {
        Pen2W::new(self, 2)
    }
    #[doc = "Bit 3 - Touch Sensing Input Pin Enable Register 3"]
    #[inline(always)]
    #[must_use]
    pub fn pen3(&mut self) -> Pen3W<PenSpec> {
        Pen3W::new(self, 3)
    }
    #[doc = "Bit 4 - Touch Sensing Input Pin Enable Register 4"]
    #[inline(always)]
    #[must_use]
    pub fn pen4(&mut self) -> Pen4W<PenSpec> {
        Pen4W::new(self, 4)
    }
    #[doc = "Bit 5 - Touch Sensing Input Pin Enable Register 5"]
    #[inline(always)]
    #[must_use]
    pub fn pen5(&mut self) -> Pen5W<PenSpec> {
        Pen5W::new(self, 5)
    }
    #[doc = "Bit 6 - Touch Sensing Input Pin Enable Register 6"]
    #[inline(always)]
    #[must_use]
    pub fn pen6(&mut self) -> Pen6W<PenSpec> {
        Pen6W::new(self, 6)
    }
    #[doc = "Bit 7 - Touch Sensing Input Pin Enable Register 7"]
    #[inline(always)]
    #[must_use]
    pub fn pen7(&mut self) -> Pen7W<PenSpec> {
        Pen7W::new(self, 7)
    }
    #[doc = "Bit 8 - Touch Sensing Input Pin Enable Register 8"]
    #[inline(always)]
    #[must_use]
    pub fn pen8(&mut self) -> Pen8W<PenSpec> {
        Pen8W::new(self, 8)
    }
    #[doc = "Bit 9 - Touch Sensing Input Pin Enable Register 9"]
    #[inline(always)]
    #[must_use]
    pub fn pen9(&mut self) -> Pen9W<PenSpec> {
        Pen9W::new(self, 9)
    }
    #[doc = "Bit 10 - Touch Sensing Input Pin Enable Register 10"]
    #[inline(always)]
    #[must_use]
    pub fn pen10(&mut self) -> Pen10W<PenSpec> {
        Pen10W::new(self, 10)
    }
    #[doc = "Bit 11 - Touch Sensing Input Pin Enable Register 11"]
    #[inline(always)]
    #[must_use]
    pub fn pen11(&mut self) -> Pen11W<PenSpec> {
        Pen11W::new(self, 11)
    }
    #[doc = "Bit 12 - Touch Sensing Input Pin Enable Register 12"]
    #[inline(always)]
    #[must_use]
    pub fn pen12(&mut self) -> Pen12W<PenSpec> {
        Pen12W::new(self, 12)
    }
    #[doc = "Bit 13 - Touch Sensing Input Pin Enable Register 13"]
    #[inline(always)]
    #[must_use]
    pub fn pen13(&mut self) -> Pen13W<PenSpec> {
        Pen13W::new(self, 13)
    }
    #[doc = "Bit 14 - Touch Sensing Input Pin Enable Register 14"]
    #[inline(always)]
    #[must_use]
    pub fn pen14(&mut self) -> Pen14W<PenSpec> {
        Pen14W::new(self, 14)
    }
    #[doc = "Bit 15 - Touch Sensing Input Pin Enable Register 15"]
    #[inline(always)]
    #[must_use]
    pub fn pen15(&mut self) -> Pen15W<PenSpec> {
        Pen15W::new(self, 15)
    }
    #[doc = "Bits 16:19 - Low Power Scan Pin"]
    #[inline(always)]
    #[must_use]
    pub fn lpsp(&mut self) -> LpspW<PenSpec> {
        LpspW::new(self, 16)
    }
}
