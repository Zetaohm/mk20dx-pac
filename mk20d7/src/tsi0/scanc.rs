...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ampsc(&mut self) -> AmpscW<ScancSpec> {
        AmpscW::new(self, 0)
    }
    #[doc = "Bits 3:4 - Active Mode Clock Source"]
    #[inline(always)]
    #[must_use]
    pub fn amclks(&mut self) -> AmclksW<ScancSpec> {
        AmclksW::new(self, 3)
    }
    #[doc = "Bits 8:15 - Scan Module"]
    #[inline(always)]
    #[must_use]
    pub fn smod(&mut self) -> SmodW<ScancSpec> {
        SmodW::new(self, 8)
    }
    #[doc = "Bits 16:19 - External OSC Charge Current select"]
    #[inline(always)]
    #[must_use]
    pub fn extchrg(&mut self) -> ExtchrgW<ScancSpec> {
        ExtchrgW::new(self, 16)
    }
    #[doc = "Bits 24:27 - Ref OSC Charge Current select"]
    #[inline(always)]
    #[must_use]
    pub fn refchrg(&mut self) -> RefchrgW<ScancSpec> {
