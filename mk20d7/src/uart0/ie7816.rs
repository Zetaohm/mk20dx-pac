...
pub enum Rxte {
    #[doc = "0: The assertion of the IS7816\\[RXT\\]
bit will not result in the generation of an interrupt."]
    _0 = 0,
    #[doc = "1: The assertion of the IS7816\\[RXT\\]
bit will result in the generation of an interrupt."]
    _1 = 1,
}
...
impl RxteR {
    ...
    #[doc = "The assertion of the IS7816\\[RXT\\]
bit will not result in the generation of an interrupt."]
    #[inline(always)]
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum Txte {
    #[doc = "0: The assertion of the IS7816\\[TXT\\]
bit will not result in the generation of an interrupt."]
    _0 = 0,
    #[doc = "1: The assertion of the IS7816\\[TXT\\]
bit will result in the generation of an interrupt."]
    _1 = 1,
}
...
impl TxteR {
    ...
    #[doc = "The assertion of the IS7816\\[TXT\\]
bit will not result in the generation of an interrupt."]
    #[inline(always)]
    pub fn is_0(&self) -> bool {
        *self == Txte::_0
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum Gtve {
    #[doc = "0: The assertion of the IS7816\\[GTV\\]
bit will not result in the generation of an interrupt."]
    _0 = 0,
    #[doc = "1: The assertion of the IS7816\\[GTV\\]
bit will result in the generation of an interrupt."]
    _1 = 1,
}
...
impl GtveR {
    ...
    #[doc = "The assertion of the IS7816\\[GTV\\]
bit will not result in the generation of an interrupt."]
    #[inline(always)]
    pub fn is_0(&self) -> bool {
        *self == Gtve::_0
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum Initde {
    #[doc = "0: The assertion of the IS7816\\[INITD\\]
bit will not result in the generation of an interrupt."]
    _0 = 0,
    #[doc = "1: The assertion of the IS7816\\[INITD\\]
bit will result in the generation of an interrupt."]
    _1 = 1,
}
...
impl InitdeR {
    ...
    #[doc = "The assertion of the IS7816\\[INITD\\]
bit will not result in the generation of an interrupt."]
    #[inline(always)]
    pub fn is_0(&self) -> bool {
        *self == Initde::_0
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum Bwte {
    #[doc = "0: The assertion of the IS7816\\[BWT\\]
bit will not result in the generation of an interrupt."]
    _0 = 0,
    #[doc = "1: The assertion of the IS7816\\[BWT\\]
bit will result in the generation of an interrupt."]
    _1 = 1,
}
...
impl BwteR {
    ...
    #[doc = "The assertion of the IS7816\\[BWT\\]
bit will not result in the generation of an interrupt."]
    #[inline(always)]
    pub fn is_0(&self) -> bool {
        *self == Bwte::_0
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum Cwte {
    #[doc = "0: The assertion of the IS7816\\[CWT\\]
bit will not result in the generation of an interrupt."]
    _0 = 0,
    #[doc = "1: The assertion of the IS7816\\[CWT\\]
bit will result in the generation of an interrupt."]
    _1 = 1,
}
...
impl CwteR {
    ...
    #[doc = "The assertion of the IS7816\\[CWT\\]
bit will not result in the generation of an interrupt."]
    #[inline(always)]
    pub fn is_0(&self) -> bool {
        *self == Cwte::_0
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum Wte {
    #[doc = "0: The assertion of the IS7816\\[WT\\]
bit will not result in the generation of an interrupt."]
    _0 = 0,
    #[doc = "1: The assertion of the IS7816\\[WT\\]
bit will result in the generation of an interrupt."]
    _1 = 1,
}
...
impl WteR {
    ...
    #[doc = "The assertion of the IS7816\\[WT\\]
bit will not result in the generation of an interrupt."]
    #[inline(always)]
    pub fn is_0(&self) -> bool {
        *self == Wte::_0
