...
#[doc = "Field `ODDRST` reader - no description available"]
pub type OddrstR = crate::BitReader;
#[doc = "Field `ODDRST` writer - no description available"]
...
#[doc = "Field `HOSTMODEEN` reader - no description available"]
pub type HostmodeenR = crate::BitReader;
#[doc = "Field `HOSTMODEEN` writer - no description available"]
pub type HostmodeenW<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `RESET` reader - no description available"]
pub type ResetR = crate::BitReader;
#[doc = "Field `RESET` writer - no description available"]
pub type ResetW<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `TXSUSPENDTOKENBUSY` reader - no description available"]
pub type TxsuspendtokenbusyR = crate::BitReader;
#[doc = "Field `TXSUSPENDTOKENBUSY` writer - no description available"]
