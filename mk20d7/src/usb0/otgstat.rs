...
#[doc = "Field `LINESTATESTABLE` reader - no description available"]
...
#[doc = "Field `LINESTATESTABLE` writer - no description available"]
...
#[doc = "Field `ONEMSECEN` reader - no description available"]
pub type OnemsecenR = crate::BitReader;
#[doc = "Field `ONEMSECEN` writer - no description available"]
...
#[doc = "Field `ID` reader - no description available"]
...
#[doc = "Field `ID` writer - no description available"]
