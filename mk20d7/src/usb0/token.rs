...
#[doc = "Field `TOKENENDPT` reader - no description available"]
pub type TokenendptR = crate::FieldReader;
#[doc = "Field `TOKENENDPT` writer - no description available"]
...
#[doc = "Field `TOKENPID` reader - no description available"]
...
#[doc = "Field `TOKENPID` writer - no description available"]
...
impl R {
    ...
    #[doc = "Bits 4:7 - no description available"]
    #[inline(always)]
