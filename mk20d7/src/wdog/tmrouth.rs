...
#[doc = "Field `TIMEROUTHIGH` reader - no description available"]
pub type TimerouthighR = crate::FieldReader<u16>;
#[doc = "Field `TIMEROUTHIGH` writer - no description available"]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn timerouthigh(&mut self) -> TimerouthighW<TmrouthSpec> {
